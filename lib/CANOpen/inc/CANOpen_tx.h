...
////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////
// CANOpen transport protocol ...message originator class


/*  example usage...
    CANOpen_tx CAN0_TP_tx;   // create a CANOpen transport protocol message originator object
    ...
    CANOpen_msg_t test_tp_msg;           // create a CANOpen message object
    ...
    ...
    test_tp_msg.id.set_CANOpenID(6,0xFE, 0xEC, 0xb0 ) ;
...
public:
  ...
  void SendMsg(CANOpen_msg_t *jmsg);     // if jmsg->id is a PDU1 format... RTS/CTS protocol is used
