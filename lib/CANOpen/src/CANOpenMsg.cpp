...
//    Notes       :
//******************************************************************************
void CANOpenRPDO1::rx_callback(hw_can_msg_t *Msg)
{
  //Msg2RPDO(Msg,&RPDO1);
}
...
//  Notes       : 
//******************************************************************************
void CANOpenRPDO1::Initialize(int8_t node)
{
...
//  Notes       :
//******************************************************************************
void CANOpenRPDO1::addRPDO1Msg(uint8_t nodeID)
{
  initialize();
  rx_id.set_stdID( getRPDO_ID(1,nodeID));
...
////  Notes       :
////******************************************************************************
//void CANOpenRPDO::addRPDO2Msg(uint8_t nodeID)
//{
//  CANOpenRPDO2.initialize();
...
//  Notes       :
//******************************************************************************
void CANOpenRPDO1::Msg2RPDO1()
{
  uint16_t statusWord;
  actualSpeed = mbuff.get_word(0);
  statusWord = mbuff.get_word(2);
  statusByte = mbuff.get_byte(4);
  anin01 = mbuff.get_byte(5);
  anin02 = mbuff.get_byte(6);
  actualCurrent = mbuff.get_byte(7);
  outA3 = statusWord & 0xFFFF;
}
////******************************************************************************
////  returns     : NONE.
////  Description : Get the value from the receiving message in the corresponding
...
////  Notes       :
////******************************************************************************
//void CANOpenRPDO::Msg2RPDO2(  hw_can_msg_t *Msg)
//{
