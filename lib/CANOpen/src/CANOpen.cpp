...
//  Notes       :
//******************************************************************************
void CANOpenRx::addMsgHandler(hw_can_rxmsg* CANOpenRPDO)
{
#ifdef HWC_CAN0
...
//  Notes       :
//******************************************************************************
uint16_t CANOpenRx::getRPDO_ID(   uint8_t numRPDO,
                                uint8_t nodeID)
{
...
////  Notes       :
////******************************************************************************
//uint16_t CANOpen::getTPDO_ID(   uint8_t numTPDO,
//                                uint8_t nodeID)
//{
//  if ((nodeID>=0x01) && (nodeID<=0x7B))
//    {
...
////  Notes       :
////******************************************************************************
//void CANOpenPDO::sendMsg( hw_can_msg_t* msgData)
//{
//#ifdef HWC_CAN0
//    hw_can_txq[HWC_CAN0].send_msg(msgData);
//#endif
...
////  Notes       :
////******************************************************************************
//uint16_t CANOpen::getGUARD_ID( uint8_t nodeID)
//{
//  if ((nodeID>=0x01) && (nodeID<=0x7B))
//    {
//      return (0x700 + nodeID);
...
////  Notes       :
////******************************************************************************
//void CANOpenNTM::addMsgHandler(hw_can_rxmsg* CANOpenRPDO)
//{
//#ifdef HWC_CAN0
//    hw_can_rx_handler[HWC_CAN0].add_msg(CANOpenRPDO);
//#endif
...
////  Notes       :
////******************************************************************************
//void CANOpen::sendMsg( hw_can_msg_t* msgData)
//{
//#ifdef HWC_CAN0
//    hw_can_txq[HWC_CAN0].send_msg(msgData);
//#endif
