###########################################################################
## Makefile generated for Simulink model 'rtwdemo_hyperlinks'. 
## 
## Makefile     : rtwdemo_hyperlinks.mk
## Generated on : Tue Sep 04 09:17:55 2018
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/rtwdemo_hyperlinks.exe
...
PRODUCT_NAME              = rtwdemo_hyperlinks
MAKEFILE                  = rtwdemo_hyperlinks.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Projects/SVNrepo/dibh-prod-esEMex/model
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = rtwdemo_hyperlinks_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = rtwdemo_hyperlinks_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/rtwdemo_hyperlinks.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/rtwdemo_hyperlinks_ert_rtw -I$(MATLAB_ROOT)/toolbox/rtw/rtwdemos -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils
...
DEFINES_STANDARD = -DMODEL=rtwdemo_hyperlinks -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/rtwdemo_hyperlinks_ert_rtw/rtwdemo_hyperlinks.c

MAIN_SRC = $(START_DIR)/rtwdemo_hyperlinks_ert_rtw/ert_main.c
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(LIBS) $(MAIN_OBJ)
	...
	$(LD) $(LDFLAGS) -o $(PRODUCT) @$(CMD_FILE) $(MAIN_OBJ) $(LIBS) $(SYSTEM_LIBS) $(TOOLCHAIN_LIBS)
...
%.obj : $(START_DIR)/rtwdemo_hyperlinks_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/rtwdemo_hyperlinks_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
