...
static void initialize_c6_MX_Gateway(SFc6_MX_GatewayInstanceStruct
  *chartInstance);
static void initialize_params_c6_MX_Gateway(SFc6_MX_GatewayInstanceStruct
  *chartInstance);
static void enable_c6_MX_Gateway(SFc6_MX_GatewayInstanceStruct *chartInstance);
static void disable_c6_MX_Gateway(SFc6_MX_GatewayInstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_MX_Gateway(SFc6_MX_GatewayInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c6_MX_Gateway(SFc6_MX_GatewayInstanceStruct *
  chartInstance);
static void set_sim_state_c6_MX_Gateway(SFc6_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c6_st);
static void c6_set_sim_state_side_effects_c6_MX_Gateway
  (SFc6_MX_GatewayInstanceStruct *chartInstance);
static void finalize_c6_MX_Gateway(SFc6_MX_GatewayInstanceStruct *chartInstance);
static void sf_gateway_c6_MX_Gateway(SFc6_MX_GatewayInstanceStruct
  *chartInstance);
static void mdl_start_c6_MX_Gateway(SFc6_MX_GatewayInstanceStruct *chartInstance);
static void initSimStructsc6_MX_Gateway(SFc6_MX_GatewayInstanceStruct
  *chartInstance);
static void c6_STATE(SFc6_MX_GatewayInstanceStruct *chartInstance);
static void c6_exit_internal_STATE(SFc6_MX_GatewayInstanceStruct *chartInstance);
static void c6_b_NORMAL(SFc6_MX_GatewayInstanceStruct *chartInstance);
static void c6_exit_internal_NORMAL(SFc6_MX_GatewayInstanceStruct *chartInstance);
static void c6_exit_internal_ABSENT(SFc6_MX_GatewayInstanceStruct *chartInstance);
static void c6_exit_internal_PRESENT(SFc6_MX_GatewayInstanceStruct
  *chartInstance);
static void c6_exit_internal_OORH(SFc6_MX_GatewayInstanceStruct *chartInstance);
static void c6_exit_internal_OORL(SFc6_MX_GatewayInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber, uint32_T c6_instanceNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static int32_T c6_emlrt_marshallIn(SFc6_MX_GatewayInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_b_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static uint8_T c6_b_emlrt_marshallIn(SFc6_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c6_b_tp_NON_FUNCTIONAL, const char_T
  *c6_identifier);
static uint8_T c6_c_emlrt_marshallIn(SFc6_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_c_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static uint16_T c6_d_emlrt_marshallIn(SFc6_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c6_b_CD_CONSOLE_PRESENT_LOW, const char_T
  *c6_identifier);
static uint16_T c6_e_emlrt_marshallIn(SFc6_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_d_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static const mxArray *c6_f_emlrt_marshallIn(SFc6_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c6_b_setSimStateSideEffectsInfo, const char_T
  *c6_identifier);
static const mxArray *c6_g_emlrt_marshallIn(SFc6_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc6_MX_GatewayInstanceStruct
  *chartInstance, int32_T c6_ssid);
static void c6_init_sf_message_store_memory(SFc6_MX_GatewayInstanceStruct
  *chartInstance);
static uint16_T c6__u16_s32_(SFc6_MX_GatewayInstanceStruct *chartInstance,
  int32_T c6_b, uint32_T c6_ssid_src_loc, int32_T c6_offset_src_loc, int32_T
  c6_length_src_loc);
static int32_T c6__s32_add__(SFc6_MX_GatewayInstanceStruct *chartInstance,
  int32_T c6_b, int32_T c6_c, uint32_T c6_ssid_src_loc, int32_T
  c6_offset_src_loc, int32_T c6_length_src_loc);
static void init_dsm_address_info(SFc6_MX_GatewayInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc6_MX_GatewayInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc6_MX_Gateway(chartInstance);
  ...
  chartInstance->c6_is_active_c6_MX_Gateway = 0U;
  chartInstance->c6_is_c6_MX_Gateway = c6_IN_NO_ACTIVE_CHILD;
  ...
  chartInstance)
{
  ...
  c6_c_hoistedGlobal = chartInstance->c6_is_active_c6_MX_Gateway;
  c6_d_y = NULL;
  sf_mex_assign(&c6_d_y, sf_mex_create("y", &c6_c_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c6_y, 2, c6_d_y);
  c6_d_hoistedGlobal = chartInstance->c6_is_c6_MX_Gateway;
  c6_e_y = NULL;
  ...
  *chartInstance, const mxArray *c6_st)
{
  ...
  *chartInstance->c6_state_Console = c6_b_emlrt_marshallIn(chartInstance,
  ...
  chartInstance->c6_is_active_c6_MX_Gateway = c6_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 2)),
     "is_active_c6_MX_Gateway");
  chartInstance->c6_is_c6_MX_Gateway = c6_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c6_u, 3)), "is_c6_MX_Gateway");
  ...
  c6_update_debugger_state_c6_MX_Gateway(chartInstance);
  ...
  (SFc6_MX_GatewayInstanceStruct *chartInstance)
{
  if (chartInstance->c6_doSetSimStateSideEffects != 0) {
    chartInstance->c6_tp_NON_FUNCTIONAL = (uint8_T)
      (chartInstance->c6_is_c6_MX_Gateway == c6_IN_NON_FUNCTIONAL);
    chartInstance->c6_tp_STATE = (uint8_T)(chartInstance->c6_is_c6_MX_Gateway ==
      c6_IN_STATE);
  ...
  *chartInstance)
{
  ...
  boolean_T c6_b_temp;
  boolean_T c6_out;
  c6_set_sim_state_side_effects_c6_MX_Gateway(chartInstance);
  ...
  if (chartInstance->c6_is_active_c6_MX_Gateway == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 5U, chartInstance->c6_sfEvent);
    chartInstance->c6_is_active_c6_MX_Gateway = 1U;
    ...
    *chartInstance->c6_state_Console = chartInstance->c6_NON_FUNCTIONAL;
    ...
    switch (chartInstance->c6_is_c6_MX_Gateway) {
      ...
      *chartInstance->c6_state_Console = chartInstance->c6_NON_FUNCTIONAL;
      ...
      if (c6_out) {
        ...
        chartInstance->c6_tp_NON_FUNCTIONAL = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c6_sfEvent);
        chartInstance->c6_is_c6_MX_Gateway = c6_IN_STATE;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c6_sfEvent);
...
const mxArray *sf_c6_MX_Gateway_get_eml_resolved_functions_info(void)
{
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  const mxArray *c6_y = NULL;
  SFc6_MX_GatewayInstanceStruct *chartInstance;
  chartInstance = (SFc6_MX_GatewayInstanceStruct *)chartInstanceVoid;
...
void sf_c6_MX_Gateway_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c6_MX_Gateway_get_post_codegen_info(void);
mxArray *sf_c6_MX_Gateway_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c6_MX_Gateway_get_post_codegen_info();
...
mxArray *sf_c6_MX_Gateway_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_MX_Gateway_jit_fallback_info(void)
{
...
mxArray *sf_c6_MX_Gateway_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c6_MX_Gateway(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[35],T\"state_Console\",},{M[3],M[42],T\"debounceCount\",},{M[8],M[0],T\"is_active_c6_MX_Gateway\",},{M[9],M[0],T\"is_c6_MX_Gateway\",},{M[9],M[3],T\"is_NORMAL\",},{M[9],M[11],T\"is_OORH\",},{M[9],M[12],T\"is_OORL\",},{M[9],M[13],T\"is_ABSENT\",},{M[9],M[14],T\"is_PRESENT\",},{M[9],M[15],T\"is_STATE\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 10, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_MX_Gateway_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc6_MX_GatewayInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc6_MX_GatewayInstanceStruct *chartInstance =
      (SFc6_MX_GatewayInstanceStruct *)sf_get_chart_instance_ptr(S);
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          static int sRelationalopType[] = { 2, 1, 1 };
...

        {
          ...
          static int sRelationalopType[] = { 4, 1, 1 };
...

        {
          ...
          static int sRelationalopType[] = { 2, 4, 1, 1, 0 };
...

        {
          ...
          static int sRelationalopType[] = { 5, 3, 0, 0, 0 };
...
static void sf_opaque_initialize_c6_MX_Gateway(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_MX_GatewayInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c6_MX_Gateway((SFc6_MX_GatewayInstanceStruct*)
    chartInstanceVar);
  initialize_c6_MX_Gateway((SFc6_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_MX_Gateway(void *chartInstanceVar)
{
  enable_c6_MX_Gateway((SFc6_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_MX_Gateway(void *chartInstanceVar)
{
  disable_c6_MX_Gateway((SFc6_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_MX_Gateway(void *chartInstanceVar)
{
  sf_gateway_c6_MX_Gateway((SFc6_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c6_MX_Gateway(SimStruct* S)
{
  return get_sim_state_c6_MX_Gateway((SFc6_MX_GatewayInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c6_MX_Gateway(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c6_MX_Gateway((SFc6_MX_GatewayInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c6_MX_Gateway(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_MX_GatewayInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_MX_Gateway_optimization_info();
    }

    finalize_c6_MX_Gateway((SFc6_MX_GatewayInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_MX_Gateway((SFc6_MX_GatewayInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_MX_Gateway(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_MX_Gateway(SimStruct *S)
{
...
static void mdlRTW_c6_MX_Gateway(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_MX_Gateway(SimStruct *S)
{
  SFc6_MX_GatewayInstanceStruct *chartInstance;
  chartInstance = (SFc6_MX_GatewayInstanceStruct *)utMalloc(sizeof
    (SFc6_MX_GatewayInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc6_MX_GatewayInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c6_MX_Gateway;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c6_MX_Gateway;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c6_MX_Gateway;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_MX_Gateway;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_MX_Gateway;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c6_MX_Gateway;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c6_MX_Gateway;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c6_MX_Gateway;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_MX_Gateway;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_MX_Gateway;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c6_MX_Gateway;
  ...
  mdl_start_c6_MX_Gateway(chartInstance);
}

void c6_MX_Gateway_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_MX_Gateway(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_MX_Gateway(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_MX_Gateway(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_MX_Gateway_method_dispatcher.\n"
