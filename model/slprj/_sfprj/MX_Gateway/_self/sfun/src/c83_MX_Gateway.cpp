...
static void initialize_c83_MX_Gateway(SFc83_MX_GatewayInstanceStruct
  *chartInstance);
static void initialize_params_c83_MX_Gateway(SFc83_MX_GatewayInstanceStruct
  *chartInstance);
static void enable_c83_MX_Gateway(SFc83_MX_GatewayInstanceStruct *chartInstance);
static void disable_c83_MX_Gateway(SFc83_MX_GatewayInstanceStruct *chartInstance);
static void c83_update_debugger_state_c83_MX_Gateway
  (SFc83_MX_GatewayInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c83_MX_Gateway
  (SFc83_MX_GatewayInstanceStruct *chartInstance);
static void set_sim_state_c83_MX_Gateway(SFc83_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c83_st);
static void c83_set_sim_state_side_effects_c83_MX_Gateway
  (SFc83_MX_GatewayInstanceStruct *chartInstance);
static void finalize_c83_MX_Gateway(SFc83_MX_GatewayInstanceStruct
  *chartInstance);
static void sf_gateway_c83_MX_Gateway(SFc83_MX_GatewayInstanceStruct
  *chartInstance);
static void mdl_start_c83_MX_Gateway(SFc83_MX_GatewayInstanceStruct
  *chartInstance);
static void c83_chartstep_c83_MX_Gateway(SFc83_MX_GatewayInstanceStruct
  *chartInstance);
static void initSimStructsc83_MX_Gateway(SFc83_MX_GatewayInstanceStruct
  *chartInstance);
...
static const mxArray *c83_sf_marshallOut(void *chartInstanceVoid, void
  *c83_inData);
static int32_T c83_emlrt_marshallIn(SFc83_MX_GatewayInstanceStruct
...
static const mxArray *c83_b_sf_marshallOut(void *chartInstanceVoid, void
  *c83_inData);
static uint8_T c83_b_emlrt_marshallIn(SFc83_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c83_b_tp_Normal, const char_T *c83_identifier);
static uint8_T c83_c_emlrt_marshallIn(SFc83_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c83_u, const emlrtMsgIdentifier *c83_parentId);
...
static const mxArray *c83_c_sf_marshallOut(void *chartInstanceVoid, void
  *c83_inData);
static const mxArray *c83_d_emlrt_marshallIn(SFc83_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c83_b_setSimStateSideEffectsInfo, const char_T *
  c83_identifier);
static const mxArray *c83_e_emlrt_marshallIn(SFc83_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c83_u, const emlrtMsgIdentifier *c83_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc83_MX_GatewayInstanceStruct
  *chartInstance, int32_T c83_ssid);
static void c83_init_sf_message_store_memory(SFc83_MX_GatewayInstanceStruct
  *chartInstance);
static uint8_T c83_get_ee_DeluxeG5(SFc83_MX_GatewayInstanceStruct *chartInstance,
  uint32_T c83_elementIndex);
static void c83_set_ee_DeluxeG5(SFc83_MX_GatewayInstanceStruct *chartInstance,
  uint32_T c83_elementIndex, uint8_T c83_elementValue);
static uint8_T *c83_access_ee_DeluxeG5(SFc83_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c83_rdOnly);
static uint8_T c83_get_ee_EcoMode(SFc83_MX_GatewayInstanceStruct *chartInstance,
  uint32_T c83_elementIndex);
static void c83_set_ee_EcoMode(SFc83_MX_GatewayInstanceStruct *chartInstance,
  uint32_T c83_elementIndex, uint8_T c83_elementValue);
static uint8_T *c83_access_ee_EcoMode(SFc83_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c83_rdOnly);
static void init_dsm_address_info(SFc83_MX_GatewayInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc83_MX_GatewayInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc83_MX_Gateway(chartInstance);
  ...
  chartInstance->c83_is_active_c83_MX_Gateway = 0U;
  chartInstance->c83_is_c83_MX_Gateway = c83_IN_NO_ACTIVE_CHILD;
  ...
  (SFc83_MX_GatewayInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c83_is_active_c83_MX_Gateway == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 80U, chartInstance->c83_sfEvent);
  }

  if (chartInstance->c83_is_c83_MX_Gateway == c83_IN_Normal) {
  ...
  if (chartInstance->c83_is_c83_MX_Gateway == c83_IN_Deluxe_G55) {
  ...
  (SFc83_MX_GatewayInstanceStruct *chartInstance)
{
  ...
  c83_b_hoistedGlobal = chartInstance->c83_is_active_c83_MX_Gateway;
  c83_c_y = NULL;
  sf_mex_assign(&c83_c_y, sf_mex_create("y", &c83_b_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c83_y, 1, c83_c_y);
  c83_c_hoistedGlobal = chartInstance->c83_is_c83_MX_Gateway;
  c83_d_y = NULL;
  ...
  *chartInstance, const mxArray *c83_st)
{
  ...
  *chartInstance->c83_state_EcoMode = c83_b_emlrt_marshallIn(chartInstance,
  ...
  chartInstance->c83_is_active_c83_MX_Gateway = c83_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c83_u, 1)),
     "is_active_c83_MX_Gateway");
  chartInstance->c83_is_c83_MX_Gateway = c83_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c83_u, 2)), "is_c83_MX_Gateway");
  ...
  c83_update_debugger_state_c83_MX_Gateway(chartInstance);
  ...
  (SFc83_MX_GatewayInstanceStruct *chartInstance)
{
  if (chartInstance->c83_doSetSimStateSideEffects != 0) {
    chartInstance->c83_tp_Deluxe_G55 = (uint8_T)
      (chartInstance->c83_is_c83_MX_Gateway == c83_IN_Deluxe_G55);
    ...
    chartInstance->c83_tp_Normal = (uint8_T)
      (chartInstance->c83_is_c83_MX_Gateway == c83_IN_Normal);
...
static void sf_gateway_c83_MX_Gateway(SFc83_MX_GatewayInstanceStruct
  *chartInstance)
{
  c83_set_sim_state_side_effects_c83_MX_Gateway(chartInstance);
  ...
  chartInstance->c83_sfEvent = CALL_EVENT;
  c83_chartstep_c83_MX_Gateway(chartInstance);
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c83_is_active_c83_MX_Gateway == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 80U, chartInstance->c83_sfEvent);
    chartInstance->c83_is_active_c83_MX_Gateway = 1U;
    ...
    switch (chartInstance->c83_is_c83_MX_Gateway) {
...
const mxArray *sf_c83_MX_Gateway_get_eml_resolved_functions_info(void)
{
  ...
  *c83_inData)
{
  ...
  const mxArray *c83_y = NULL;
  SFc83_MX_GatewayInstanceStruct *chartInstance;
  chartInstance = (SFc83_MX_GatewayInstanceStruct *)chartInstanceVoid;
...
void sf_c83_MX_Gateway_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c83_MX_Gateway_get_post_codegen_info(void);
mxArray *sf_c83_MX_Gateway_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c83_MX_Gateway_get_post_codegen_info();
...
mxArray *sf_c83_MX_Gateway_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c83_MX_Gateway_jit_fallback_info(void)
{
...
mxArray *sf_c83_MX_Gateway_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c83_MX_Gateway(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[6],T\"state_EcoMode\",},{M[8],M[0],T\"is_active_c83_MX_Gateway\",},{M[9],M[0],T\"is_c83_MX_Gateway\",},{M[9],M[22],T\"is_Deluxe_G55\",},{M[9],M[24],T\"is_Normal\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c83_MX_Gateway_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc83_MX_GatewayInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc83_MX_GatewayInstanceStruct *chartInstance =
      (SFc83_MX_GatewayInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c83_MX_Gateway(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc83_MX_GatewayInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c83_MX_Gateway((SFc83_MX_GatewayInstanceStruct*)
    chartInstanceVar);
  initialize_c83_MX_Gateway((SFc83_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c83_MX_Gateway(void *chartInstanceVar)
{
  enable_c83_MX_Gateway((SFc83_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c83_MX_Gateway(void *chartInstanceVar)
{
  disable_c83_MX_Gateway((SFc83_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c83_MX_Gateway(void *chartInstanceVar)
{
  sf_gateway_c83_MX_Gateway((SFc83_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c83_MX_Gateway(SimStruct* S)
{
  return get_sim_state_c83_MX_Gateway((SFc83_MX_GatewayInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c83_MX_Gateway(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c83_MX_Gateway((SFc83_MX_GatewayInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c83_MX_Gateway(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc83_MX_GatewayInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_MX_Gateway_optimization_info();
    }

    finalize_c83_MX_Gateway((SFc83_MX_GatewayInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc83_MX_Gateway((SFc83_MX_GatewayInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c83_MX_Gateway(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c83_MX_Gateway(SimStruct *S)
{
...
static void mdlRTW_c83_MX_Gateway(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c83_MX_Gateway(SimStruct *S)
{
  SFc83_MX_GatewayInstanceStruct *chartInstance;
  chartInstance = (SFc83_MX_GatewayInstanceStruct *)utMalloc(sizeof
    (SFc83_MX_GatewayInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc83_MX_GatewayInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c83_MX_Gateway;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c83_MX_Gateway;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c83_MX_Gateway;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c83_MX_Gateway;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c83_MX_Gateway;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c83_MX_Gateway;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c83_MX_Gateway;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c83_MX_Gateway;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c83_MX_Gateway;
  chartInstance->chartInfo.mdlStart = mdlStart_c83_MX_Gateway;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c83_MX_Gateway;
  ...
  mdl_start_c83_MX_Gateway(chartInstance);
}

void c83_MX_Gateway_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c83_MX_Gateway(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c83_MX_Gateway(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c83_MX_Gateway(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c83_MX_Gateway_method_dispatcher.\n"
