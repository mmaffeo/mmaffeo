...
static void initialize_c105_MX_Gateway(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void initialize_params_c105_MX_Gateway(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void enable_c105_MX_Gateway(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void disable_c105_MX_Gateway(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_update_debugger_state_c105_MX_Gateway
  (SFc105_MX_GatewayInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c105_MX_Gateway
  (SFc105_MX_GatewayInstanceStruct *chartInstance);
static void set_sim_state_c105_MX_Gateway(SFc105_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c105_st);
static void c105_set_sim_state_side_effects_c105_MX_Gateway
  (SFc105_MX_GatewayInstanceStruct *chartInstance);
static void finalize_c105_MX_Gateway(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void sf_gateway_c105_MX_Gateway(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void mdl_start_c105_MX_Gateway(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void initSimStructsc105_MX_Gateway(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_OptionA(SFc105_MX_GatewayInstanceStruct *chartInstance);
static void c105_Left_Control_or_Diverter_Fault(SFc105_MX_GatewayInstanceStruct *
  chartInstance);
static void c105_exit_internal_Left_Control_or_Diverter_Fault
  (SFc105_MX_GatewayInstanceStruct *chartInstance);
static void c105_exit_internal_Enabled(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_enter_internal_Aux_Enabled(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_Aux_Enabled(SFc105_MX_GatewayInstanceStruct *chartInstance);
static void c105_exit_internal_Aux_Enabled(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_OptionB(SFc105_MX_GatewayInstanceStruct *chartInstance);
static void c105_enter_atomic_INIT_SystemCheck(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_Enabled(SFc105_MX_GatewayInstanceStruct *chartInstance);
static void c105_b_exit_internal_Enabled(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_enter_internal_Offset_Left(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_Offset_Left(SFc105_MX_GatewayInstanceStruct *chartInstance);
static void c105_exit_internal_Offset_Left(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_b_enter_internal_Aux_Enabled(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_b_Aux_Enabled(SFc105_MX_GatewayInstanceStruct *chartInstance);
static void c105_b_exit_internal_Aux_Enabled(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_enter_atomic_Control_Fault(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_enter_internal_Offset_Right(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_Offset_Right(SFc105_MX_GatewayInstanceStruct *chartInstance);
static void c105_exit_internal_Offset_Right(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_c_enter_internal_Aux_Enabled(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_c_Aux_Enabled(SFc105_MX_GatewayInstanceStruct *chartInstance);
static void c105_c_exit_internal_Aux_Enabled(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_OptionC(SFc105_MX_GatewayInstanceStruct *chartInstance);
static void c105_b_enter_atomic_INIT_SystemCheck(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_b_Enabled(SFc105_MX_GatewayInstanceStruct *chartInstance);
static void c105_c_exit_internal_Enabled(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_b_enter_internal_Offset_Left(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_b_Offset_Left(SFc105_MX_GatewayInstanceStruct *chartInstance);
static void c105_b_exit_internal_Offset_Left(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_d_enter_internal_Aux_Enabled(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_d_Aux_Enabled(SFc105_MX_GatewayInstanceStruct *chartInstance);
static void c105_d_exit_internal_Aux_Enabled(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_Mode_Offset_Aux4(SFc105_MX_GatewayInstanceStruct *chartInstance);
static void c105_Mode_Offset_Aux1(SFc105_MX_GatewayInstanceStruct *chartInstance);
static void c105_enter_atomic_Mode_Offset_None(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_b_enter_atomic_Control_Fault(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_b_enter_internal_Offset_Right(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_b_Offset_Right(SFc105_MX_GatewayInstanceStruct *chartInstance);
static void c105_b_exit_internal_Offset_Right(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_e_enter_internal_Aux_Enabled(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_e_Aux_Enabled(SFc105_MX_GatewayInstanceStruct *chartInstance);
static void c105_e_exit_internal_Aux_Enabled(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_Mode_Aux4_Offset(SFc105_MX_GatewayInstanceStruct *chartInstance);
...
static void c105_DiverterFaultOverrideLeft(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static void c105_DiverterFaultOverrideRight(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static const mxArray *c105_sf_marshallOut(void *chartInstanceVoid, void
  *c105_inData);
static int32_T c105_emlrt_marshallIn(SFc105_MX_GatewayInstanceStruct
...
static const mxArray *c105_b_sf_marshallOut(void *chartInstanceVoid, void
  *c105_inData);
static uint8_T c105_b_emlrt_marshallIn(SFc105_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c105_b_tp_Non_Functional, const char_T
  *c105_identifier);
static uint8_T c105_c_emlrt_marshallIn(SFc105_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c105_u, const emlrtMsgIdentifier *c105_parentId);
...
static const mxArray *c105_c_sf_marshallOut(void *chartInstanceVoid, void
  *c105_inData);
static boolean_T c105_d_emlrt_marshallIn(SFc105_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c105_b_flag_AuxEnableFlash, const char_T
  *c105_identifier);
static boolean_T c105_e_emlrt_marshallIn(SFc105_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c105_u, const emlrtMsgIdentifier *c105_parentId);
static void c105_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c105_mxArrayInData, const char_T *c105_varName, void *c105_outData);
static const mxArray *c105_f_emlrt_marshallIn(SFc105_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c105_b_setSimStateSideEffectsInfo, const char_T
  *c105_identifier);
static const mxArray *c105_g_emlrt_marshallIn(SFc105_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c105_u, const emlrtMsgIdentifier *c105_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc105_MX_GatewayInstanceStruct *
  chartInstance, int32_T c105_ssid);
static void c105_init_sf_message_store_memory(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
static uint8_T c105__u8_s32_(SFc105_MX_GatewayInstanceStruct *chartInstance,
  int32_T c105_b, uint32_T c105_ssid_src_loc, int32_T c105_offset_src_loc,
  int32_T c105_length_src_loc);
static uint8_T c105_get_ee_ControlMode(SFc105_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c105_elementIndex);
static void c105_set_ee_ControlMode(SFc105_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c105_elementIndex, uint8_T c105_elementValue);
static uint8_T *c105_access_ee_ControlMode(SFc105_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c105_rdOnly);
static uint8_T c105_get_state_Buzzer(SFc105_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c105_elementIndex);
static void c105_set_state_Buzzer(SFc105_MX_GatewayInstanceStruct *chartInstance,
  uint32_T c105_elementIndex, uint8_T c105_elementValue);
static uint8_T *c105_access_state_Buzzer(SFc105_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c105_rdOnly);
static void init_dsm_address_info(SFc105_MX_GatewayInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc105_MX_GatewayInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc105_MX_Gateway(chartInstance);
  ...
  chartInstance->c105_is_active_c105_MX_Gateway = 0U;
  chartInstance->c105_is_c105_MX_Gateway = c105_IN_NO_ACTIVE_CHILD;
  ...
  (SFc105_MX_GatewayInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c105_is_c105_MX_Gateway == c105_IN_OptionB) {
  ...
  if (chartInstance->c105_is_c105_MX_Gateway == c105_IN_OptionC) {
  ...
  (SFc105_MX_GatewayInstanceStruct *chartInstance)
{
  ...
  c105_i_hoistedGlobal = chartInstance->c105_is_active_c105_MX_Gateway;
  c105_j_y = NULL;
  sf_mex_assign(&c105_j_y, sf_mex_create("y", &c105_i_hoistedGlobal, 3, 0U, 0U,
    0U, 0), false);
  sf_mex_setcell(c105_y, 8, c105_j_y);
  c105_j_hoistedGlobal = chartInstance->c105_is_c105_MX_Gateway;
  c105_k_y = NULL;
  ...
  *chartInstance, const mxArray *c105_st)
{
  ...
  *chartInstance->c105_mode_RightControl = c105_b_emlrt_marshallIn(chartInstance,
  ...
  chartInstance->c105_is_active_c105_MX_Gateway = c105_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c105_u, 8)),
     "is_active_c105_MX_Gateway");
  chartInstance->c105_is_c105_MX_Gateway = c105_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c105_u, 9)), "is_c105_MX_Gateway");
  ...
  c105_update_debugger_state_c105_MX_Gateway(chartInstance);
  ...
  (SFc105_MX_GatewayInstanceStruct *chartInstance)
{
  if (chartInstance->c105_doSetSimStateSideEffects != 0) {
    chartInstance->c105_tp_Non_Functional = (uint8_T)
      (chartInstance->c105_is_c105_MX_Gateway == c105_IN_Non_Functional);
    chartInstance->c105_tp_OptionA = (uint8_T)
      (chartInstance->c105_is_c105_MX_Gateway == c105_IN_OptionA);
    ...
    chartInstance->c105_tp_OptionB = (uint8_T)
      (chartInstance->c105_is_c105_MX_Gateway == c105_IN_OptionB);
    if (chartInstance->c105_is_OptionB == c105_IN_Delay) {
    ...
    chartInstance->c105_tp_OptionC = (uint8_T)
      (chartInstance->c105_is_c105_MX_Gateway == c105_IN_OptionC);
    if (chartInstance->c105_is_OptionC == c105_IN_Delay) {
  ...
  *chartInstance)
{
  ...
  c105_set_sim_state_side_effects_c105_MX_Gateway(chartInstance);
  ...
  if (chartInstance->c105_is_active_c105_MX_Gateway == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 101U,
                 chartInstance->c105_sfEvent);
    chartInstance->c105_is_active_c105_MX_Gateway = 1U;
    ...
    *chartInstance->c105_display_request = false;
    ...
    switch (chartInstance->c105_is_c105_MX_Gateway) {
...
const mxArray *sf_c105_MX_Gateway_get_eml_resolved_functions_info(void)
{
  ...
  *c105_inData)
{
  ...
  const mxArray *c105_y = NULL;
  SFc105_MX_GatewayInstanceStruct *chartInstance;
  chartInstance = (SFc105_MX_GatewayInstanceStruct *)chartInstanceVoid;
...
void sf_c105_MX_Gateway_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c105_MX_Gateway_get_post_codegen_info(void);
mxArray *sf_c105_MX_Gateway_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c105_MX_Gateway_get_post_codegen_info();
...
mxArray *sf_c105_MX_Gateway_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c105_MX_Gateway_jit_fallback_info(void)
{
...
mxArray *sf_c105_MX_Gateway_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c105_MX_Gateway(void)
{
  ...
  sf_c105_MX_Gateway_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc105_MX_GatewayInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc105_MX_GatewayInstanceStruct *chartInstance =
      (SFc105_MX_GatewayInstanceStruct *)sf_get_chart_instance_ptr(S);
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          static int sRelationalopType[] = { 0, 1, 0 };
...
static void sf_opaque_initialize_c105_MX_Gateway(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc105_MX_GatewayInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c105_MX_Gateway((SFc105_MX_GatewayInstanceStruct*)
    chartInstanceVar);
  initialize_c105_MX_Gateway((SFc105_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c105_MX_Gateway(void *chartInstanceVar)
{
  enable_c105_MX_Gateway((SFc105_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c105_MX_Gateway(void *chartInstanceVar)
{
  disable_c105_MX_Gateway((SFc105_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c105_MX_Gateway(void *chartInstanceVar)
{
  sf_gateway_c105_MX_Gateway((SFc105_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c105_MX_Gateway(SimStruct* S)
{
  return get_sim_state_c105_MX_Gateway((SFc105_MX_GatewayInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c105_MX_Gateway(SimStruct* S, const mxArray *
  st)
{
  set_sim_state_c105_MX_Gateway((SFc105_MX_GatewayInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c105_MX_Gateway(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc105_MX_GatewayInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_MX_Gateway_optimization_info();
    }

    finalize_c105_MX_Gateway((SFc105_MX_GatewayInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc105_MX_Gateway((SFc105_MX_GatewayInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c105_MX_Gateway(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c105_MX_Gateway(SimStruct *S)
{
...
static void mdlRTW_c105_MX_Gateway(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c105_MX_Gateway(SimStruct *S)
{
  SFc105_MX_GatewayInstanceStruct *chartInstance;
  chartInstance = (SFc105_MX_GatewayInstanceStruct *)utMalloc(sizeof
    (SFc105_MX_GatewayInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc105_MX_GatewayInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c105_MX_Gateway;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c105_MX_Gateway;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c105_MX_Gateway;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c105_MX_Gateway;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c105_MX_Gateway;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c105_MX_Gateway;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c105_MX_Gateway;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c105_MX_Gateway;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c105_MX_Gateway;
  chartInstance->chartInfo.mdlStart = mdlStart_c105_MX_Gateway;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c105_MX_Gateway;
  ...
  mdl_start_c105_MX_Gateway(chartInstance);
}

void c105_MX_Gateway_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c105_MX_Gateway(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c105_MX_Gateway(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c105_MX_Gateway(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c105_MX_Gateway_method_dispatcher.\n"
