#ifndef __c6_MX_Gateway_h__
#define __c6_MX_Gateway_h__

/* Type Definitions */
#ifndef typedef_SFc6_MX_GatewayInstanceStruct
#define typedef_SFc6_MX_GatewayInstanceStruct
...
typedef struct {
  ...
  uint8_T c6_is_active_c6_MX_Gateway;
  uint8_T c6_is_c6_MX_Gateway;
  uint8_T c6_is_STATE;
...
#endif                                 /*typedef_SFc6_MX_GatewayInstanceStruct*/
...
extern const mxArray *sf_c6_MX_Gateway_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c6_MX_Gateway_get_check_sum(mxArray *plhs[]);
extern void c6_MX_Gateway_method_dispatcher(SimStruct *S, int_T method, void
  *data);
