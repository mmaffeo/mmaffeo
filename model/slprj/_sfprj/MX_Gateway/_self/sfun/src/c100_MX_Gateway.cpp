...
static void initialize_c100_MX_Gateway(SFc100_MX_GatewayInstanceStruct
  *chartInstance);
static void initialize_params_c100_MX_Gateway(SFc100_MX_GatewayInstanceStruct
  *chartInstance);
static void enable_c100_MX_Gateway(SFc100_MX_GatewayInstanceStruct
  *chartInstance);
static void disable_c100_MX_Gateway(SFc100_MX_GatewayInstanceStruct
  *chartInstance);
static void c100_update_debugger_state_c100_MX_Gateway
  (SFc100_MX_GatewayInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c100_MX_Gateway
  (SFc100_MX_GatewayInstanceStruct *chartInstance);
static void set_sim_state_c100_MX_Gateway(SFc100_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c100_st);
static void c100_set_sim_state_side_effects_c100_MX_Gateway
  (SFc100_MX_GatewayInstanceStruct *chartInstance);
static void finalize_c100_MX_Gateway(SFc100_MX_GatewayInstanceStruct
  *chartInstance);
static void sf_gateway_c100_MX_Gateway(SFc100_MX_GatewayInstanceStruct
  *chartInstance);
static void mdl_start_c100_MX_Gateway(SFc100_MX_GatewayInstanceStruct
  *chartInstance);
static void c100_chartstep_c100_MX_Gateway(SFc100_MX_GatewayInstanceStruct
  *chartInstance);
static void initSimStructsc100_MX_Gateway(SFc100_MX_GatewayInstanceStruct
  *chartInstance);
static void c100_ReminderOfLastState(SFc100_MX_GatewayInstanceStruct
  *chartInstance);
static void c100_exit_internal_ReminderOfLastState
  (SFc100_MX_GatewayInstanceStruct *chartInstance);
static void c100_enter_internal_Flasher(SFc100_MX_GatewayInstanceStruct
  *chartInstance);
static void c100_Flasher(SFc100_MX_GatewayInstanceStruct *chartInstance);
static void c100_exit_internal_Flasher(SFc100_MX_GatewayInstanceStruct
  *chartInstance);
static void c100_OF_A1FLASH(SFc100_MX_GatewayInstanceStruct *chartInstance);
static void c100_OF_A4FLASH(SFc100_MX_GatewayInstanceStruct *chartInstance);
static void c100_A4FLASH_OF(SFc100_MX_GatewayInstanceStruct *chartInstance);
...
static const mxArray *c100_sf_marshallOut(void *chartInstanceVoid, void
  *c100_inData);
static int32_T c100_emlrt_marshallIn(SFc100_MX_GatewayInstanceStruct
...
static const mxArray *c100_b_sf_marshallOut(void *chartInstanceVoid, void
  *c100_inData);
static uint8_T c100_b_emlrt_marshallIn(SFc100_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c100_b_tp_Normal, const char_T *c100_identifier);
static uint8_T c100_c_emlrt_marshallIn(SFc100_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c100_u, const emlrtMsgIdentifier *c100_parentId);
...
static const mxArray *c100_c_sf_marshallOut(void *chartInstanceVoid, void
  *c100_inData);
static boolean_T c100_d_emlrt_marshallIn(SFc100_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c100_b_flag_AuxEnableFlash, const char_T
  *c100_identifier);
static boolean_T c100_e_emlrt_marshallIn(SFc100_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c100_u, const emlrtMsgIdentifier *c100_parentId);
...
static const mxArray *c100_d_sf_marshallOut(void *chartInstanceVoid, void
  *c100_inData);
static uint16_T c100_f_emlrt_marshallIn(SFc100_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c100_b_CD_EMEA_CONTROLS_FLASH_TIME, const
  char_T *c100_identifier);
static uint16_T c100_g_emlrt_marshallIn(SFc100_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c100_u, const emlrtMsgIdentifier *c100_parentId);
static void c100_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c100_mxArrayInData, const char_T *c100_varName, void *c100_outData);
static const mxArray *c100_h_emlrt_marshallIn(SFc100_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c100_b_setSimStateSideEffectsInfo, const char_T
  *c100_identifier);
static const mxArray *c100_i_emlrt_marshallIn(SFc100_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c100_u, const emlrtMsgIdentifier *c100_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc100_MX_GatewayInstanceStruct *
  chartInstance, int32_T c100_ssid);
static void c100_init_sf_message_store_memory(SFc100_MX_GatewayInstanceStruct
  *chartInstance);
static int32_T c100__s32_add__(SFc100_MX_GatewayInstanceStruct *chartInstance,
  int32_T c100_b, int32_T c100_c, uint32_T c100_ssid_src_loc, int32_T
  c100_offset_src_loc, int32_T c100_length_src_loc);
static uint16_T c100__u16_u32_(SFc100_MX_GatewayInstanceStruct *chartInstance,
  uint32_T c100_b, uint32_T c100_ssid_src_loc, int32_T c100_offset_src_loc,
  int32_T c100_length_src_loc);
static uint8_T c100_get_ee_ControlMode(SFc100_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c100_elementIndex);
static void c100_set_ee_ControlMode(SFc100_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c100_elementIndex, uint8_T c100_elementValue);
static uint8_T *c100_access_ee_ControlMode(SFc100_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c100_rdOnly);
static void init_dsm_address_info(SFc100_MX_GatewayInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc100_MX_GatewayInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc100_MX_Gateway(chartInstance);
  ...
  chartInstance->c100_temporalCounter_i1 = 0U;
  chartInstance->c100_is_active_c100_MX_Gateway = 0U;
  chartInstance->c100_is_c100_MX_Gateway = c100_IN_NO_ACTIVE_CHILD;
  ...
  (SFc100_MX_GatewayInstanceStruct *chartInstance)
{
  ...
  c100_e_hoistedGlobal = chartInstance->c100_is_active_c100_MX_Gateway;
  c100_f_y = NULL;
  ...
  c100_h_hoistedGlobal = chartInstance->c100_is_c100_MX_Gateway;
  c100_i_y = NULL;
  ...
  *chartInstance, const mxArray *c100_st)
{
  ...
  *chartInstance->c100_flag_AuxEnableFlash = c100_d_emlrt_marshallIn
  ...
  chartInstance->c100_is_active_c100_MX_Gateway = c100_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c100_u, 4)),
     "is_active_c100_MX_Gateway");
  ...
  chartInstance->c100_is_c100_MX_Gateway = c100_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c100_u, 7)), "is_c100_MX_Gateway");
  ...
  c100_update_debugger_state_c100_MX_Gateway(chartInstance);
  ...
  (SFc100_MX_GatewayInstanceStruct *chartInstance)
{
  if (chartInstance->c100_doSetSimStateSideEffects != 0) {
    chartInstance->c100_tp_Init = (uint8_T)
      (chartInstance->c100_is_c100_MX_Gateway == c100_IN_Init);
    chartInstance->c100_tp_Normal = (uint8_T)
      (chartInstance->c100_is_c100_MX_Gateway == c100_IN_Normal);
    chartInstance->c100_tp_OffsetCheck = (uint8_T)
      (chartInstance->c100_is_c100_MX_Gateway == c100_IN_OffsetCheck);
    chartInstance->c100_tp_ReminderOfLastState = (uint8_T)
      (chartInstance->c100_is_c100_MX_Gateway == c100_IN_ReminderOfLastState);
...
static void sf_gateway_c100_MX_Gateway(SFc100_MX_GatewayInstanceStruct
  *chartInstance)
{
  c100_set_sim_state_side_effects_c100_MX_Gateway(chartInstance);
  ...
  c100_chartstep_c100_MX_Gateway(chartInstance);
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c100_is_active_c100_MX_Gateway == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 97U,
                 chartInstance->c100_sfEvent);
    chartInstance->c100_is_active_c100_MX_Gateway = 1U;
    ...
    *chartInstance->c100_flag_AuxEnableFlash = false;
    ...
    switch (chartInstance->c100_is_c100_MX_Gateway) {
     case c100_IN_Init:
...
const mxArray *sf_c100_MX_Gateway_get_eml_resolved_functions_info(void)
{
  ...
  *c100_inData)
{
  ...
  const mxArray *c100_y = NULL;
  SFc100_MX_GatewayInstanceStruct *chartInstance;
  chartInstance = (SFc100_MX_GatewayInstanceStruct *)chartInstanceVoid;
...
void sf_c100_MX_Gateway_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c100_MX_Gateway_get_post_codegen_info(void);
mxArray *sf_c100_MX_Gateway_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c100_MX_Gateway_get_post_codegen_info();
...
mxArray *sf_c100_MX_Gateway_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c100_MX_Gateway_jit_fallback_info(void)
{
...
mxArray *sf_c100_MX_Gateway_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c100_MX_Gateway(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[88],T\"disp_LeftControl\",},{M[1],M[89],T\"disp_RightControl\",},{M[1],M[93],T\"flag_AuxEnableFlash\",},{M[3],M[149],T\"flash_timer\",},{M[8],M[0],T\"is_active_c100_MX_Gateway\",},{M[8],M[141],T\"is_active_Flasher\",},{M[8],M[142],T\"is_active_FlashTimer\",},{M[9],M[0],T\"is_c100_MX_Gateway\",},{M[9],M[19],T\"is_OF_A1FLASH\",},{M[9],M[28],T\"is_OF_A4FLASH\",}}",
  ...
  sf_c100_MX_Gateway_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc100_MX_GatewayInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc100_MX_GatewayInstanceStruct *chartInstance =
      (SFc100_MX_GatewayInstanceStruct *)sf_get_chart_instance_ptr(S);
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          static int sRelationalopType[] = { 1, 1, 0, 0, 1 };
...

        {
          ...
          static int sRelationalopType[] = { 2, 0, 4, 0 };
...
static void sf_opaque_initialize_c100_MX_Gateway(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc100_MX_GatewayInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c100_MX_Gateway((SFc100_MX_GatewayInstanceStruct*)
    chartInstanceVar);
  initialize_c100_MX_Gateway((SFc100_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c100_MX_Gateway(void *chartInstanceVar)
{
  enable_c100_MX_Gateway((SFc100_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c100_MX_Gateway(void *chartInstanceVar)
{
  disable_c100_MX_Gateway((SFc100_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c100_MX_Gateway(void *chartInstanceVar)
{
  sf_gateway_c100_MX_Gateway((SFc100_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c100_MX_Gateway(SimStruct* S)
{
  return get_sim_state_c100_MX_Gateway((SFc100_MX_GatewayInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c100_MX_Gateway(SimStruct* S, const mxArray *
  st)
{
  set_sim_state_c100_MX_Gateway((SFc100_MX_GatewayInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c100_MX_Gateway(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc100_MX_GatewayInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_MX_Gateway_optimization_info();
    }

    finalize_c100_MX_Gateway((SFc100_MX_GatewayInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc100_MX_Gateway((SFc100_MX_GatewayInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c100_MX_Gateway(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c100_MX_Gateway(SimStruct *S)
{
...
static void mdlRTW_c100_MX_Gateway(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c100_MX_Gateway(SimStruct *S)
{
  SFc100_MX_GatewayInstanceStruct *chartInstance;
  chartInstance = (SFc100_MX_GatewayInstanceStruct *)utMalloc(sizeof
    (SFc100_MX_GatewayInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc100_MX_GatewayInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c100_MX_Gateway;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c100_MX_Gateway;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c100_MX_Gateway;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c100_MX_Gateway;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c100_MX_Gateway;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c100_MX_Gateway;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c100_MX_Gateway;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c100_MX_Gateway;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c100_MX_Gateway;
  chartInstance->chartInfo.mdlStart = mdlStart_c100_MX_Gateway;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c100_MX_Gateway;
  ...
  mdl_start_c100_MX_Gateway(chartInstance);
}

void c100_MX_Gateway_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c100_MX_Gateway(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c100_MX_Gateway(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c100_MX_Gateway(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c100_MX_Gateway_method_dispatcher.\n"
