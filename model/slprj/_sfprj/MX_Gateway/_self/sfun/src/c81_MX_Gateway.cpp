...
static void initialize_c81_MX_Gateway(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
static void initialize_params_c81_MX_Gateway(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
static void enable_c81_MX_Gateway(SFc81_MX_GatewayInstanceStruct *chartInstance);
static void disable_c81_MX_Gateway(SFc81_MX_GatewayInstanceStruct *chartInstance);
static void c81_update_debugger_state_c81_MX_Gateway
  (SFc81_MX_GatewayInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c81_MX_Gateway
  (SFc81_MX_GatewayInstanceStruct *chartInstance);
static void set_sim_state_c81_MX_Gateway(SFc81_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c81_st);
static void c81_set_sim_state_side_effects_c81_MX_Gateway
  (SFc81_MX_GatewayInstanceStruct *chartInstance);
static void finalize_c81_MX_Gateway(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
static void sf_gateway_c81_MX_Gateway(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
static void mdl_start_c81_MX_Gateway(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
static void c81_chartstep_c81_MX_Gateway(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
static void initSimStructsc81_MX_Gateway(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
static void c81_BUTTON_STATE(SFc81_MX_GatewayInstanceStruct *chartInstance);
static void c81_INFO_BUTTON(SFc81_MX_GatewayInstanceStruct *chartInstance);
static void c81_PRIMARY_STATE(SFc81_MX_GatewayInstanceStruct *chartInstance);
static void c81_enter_internal_ACTIVE(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
static void c81_b_ACTIVE(SFc81_MX_GatewayInstanceStruct *chartInstance);
static void c81_exit_internal_ACTIVE(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
static void c81_ENGINE_HOURS(SFc81_MX_GatewayInstanceStruct *chartInstance);
static void c81_exit_internal_ENGINE_HOURS(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
static void c81_JOB_CLOCK_1(SFc81_MX_GatewayInstanceStruct *chartInstance);
static void c81_exit_internal_JOB_CLOCK_1(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
static void c81_JOB_CLOCK_RESET1(SFc81_MX_GatewayInstanceStruct *chartInstance);
static void c81_JOB_CLOCK_2(SFc81_MX_GatewayInstanceStruct *chartInstance);
static void c81_exit_internal_JOB_CLOCK_2(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
static void c81_JOB_CLOCK_RESET2(SFc81_MX_GatewayInstanceStruct *chartInstance);
static void c81_enter_internal_FACTORY(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
static void c81_FACTORY(SFc81_MX_GatewayInstanceStruct *chartInstance);
static void c81_exit_internal_FACTORY(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
static void c81_ENGINE_RPM(SFc81_MX_GatewayInstanceStruct *chartInstance);
static void c81_SERVICE_CLOCK_RESET(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
static void c81_SERVICE_CLOCK(SFc81_MX_GatewayInstanceStruct *chartInstance);
static void c81_exit_internal_SERVICE_CLOCK(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
static void c81_ERROR_CODES(SFc81_MX_GatewayInstanceStruct *chartInstance);
static void c81_HOT2(SFc81_MX_GatewayInstanceStruct *chartInstance);
static void c81_SECOND_AUX(SFc81_MX_GatewayInstanceStruct *chartInstance);
static void c81_enter_atomic_ERROR_CODES(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
static void c81_SECONDARY_STATE(SFc81_MX_GatewayInstanceStruct *chartInstance);
static void c81_exit_internal_DELUXE_GOOD(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
static void c81_NON_SHUTDOWN(SFc81_MX_GatewayInstanceStruct *chartInstance);
static void c81_exit_internal_NON_SHUTDOWN(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
static void c81_NO_STATE(SFc81_MX_GatewayInstanceStruct *chartInstance);
static void c81_THROTTLE_CAL_DIAGNOSTICS(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
static void c81_exit_internal_Aux_Detent_Error(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
...
static const mxArray *c81_sf_marshallOut(void *chartInstanceVoid, void
  *c81_inData);
static int32_T c81_emlrt_marshallIn(SFc81_MX_GatewayInstanceStruct
...
static const mxArray *c81_b_sf_marshallOut(void *chartInstanceVoid, void
  *c81_inData);
static uint8_T c81_b_emlrt_marshallIn(SFc81_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c81_b_tp_BUTTON_STATE, const char_T
  *c81_identifier);
static uint8_T c81_c_emlrt_marshallIn(SFc81_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c81_u, const emlrtMsgIdentifier *c81_parentId);
...
static const mxArray *c81_c_sf_marshallOut(void *chartInstanceVoid, void
  *c81_inData);
static uint16_T c81_d_emlrt_marshallIn(SFc81_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c81_b_debounceCount, const char_T
  *c81_identifier);
static uint16_T c81_e_emlrt_marshallIn(SFc81_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c81_u, const emlrtMsgIdentifier *c81_parentId);
...
static const mxArray *c81_e_sf_marshallOut(void *chartInstanceVoid, void
  *c81_inData);
static void c81_f_emlrt_marshallIn(SFc81_MX_GatewayInstanceStruct *chartInstance,
  const mxArray *c81_u, const emlrtMsgIdentifier *c81_parentId, uint8_T c81_y[2]);
...
static const mxArray *c81_f_sf_marshallOut(void *chartInstanceVoid, void
  *c81_inData);
static boolean_T c81_g_emlrt_marshallIn(SFc81_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c81_b_prev_SecondAux, const char_T
  *c81_identifier);
static boolean_T c81_h_emlrt_marshallIn(SFc81_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c81_u, const emlrtMsgIdentifier *c81_parentId);
static void c81_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c81_mxArrayInData, const char_T *c81_varName, void *c81_outData);
static const mxArray *c81_i_emlrt_marshallIn(SFc81_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c81_b_setSimStateSideEffectsInfo, const char_T *
  c81_identifier);
static const mxArray *c81_j_emlrt_marshallIn(SFc81_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c81_u, const emlrtMsgIdentifier *c81_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc81_MX_GatewayInstanceStruct
  *chartInstance, int32_T c81_ssid);
static void c81_init_sf_message_store_memory(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
static uint16_T c81__u16_s32_(SFc81_MX_GatewayInstanceStruct *chartInstance,
  int32_T c81_b, uint32_T c81_ssid_src_loc, int32_T c81_offset_src_loc, int32_T
  c81_length_src_loc);
static uint8_T c81__u8_s32_(SFc81_MX_GatewayInstanceStruct *chartInstance,
  int32_T c81_b, uint32_T c81_ssid_src_loc, int32_T c81_offset_src_loc, int32_T
  c81_length_src_loc);
static int32_T c81__s32_add__(SFc81_MX_GatewayInstanceStruct *chartInstance,
  int32_T c81_b, int32_T c81_c, uint32_T c81_ssid_src_loc, int32_T
  c81_offset_src_loc, int32_T c81_length_src_loc);
static uint16_T c81__u16_u32_(SFc81_MX_GatewayInstanceStruct *chartInstance,
  uint32_T c81_b, uint32_T c81_ssid_src_loc, int32_T c81_offset_src_loc, int32_T
  c81_length_src_loc);
static uint8_T c81_get_ee_DeluxeG5(SFc81_MX_GatewayInstanceStruct *chartInstance,
  uint32_T c81_elementIndex);
static void c81_set_ee_DeluxeG5(SFc81_MX_GatewayInstanceStruct *chartInstance,
  uint32_T c81_elementIndex, uint8_T c81_elementValue);
static uint8_T *c81_access_ee_DeluxeG5(SFc81_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c81_rdOnly);
static uint8_T c81_get_ee_EngData(SFc81_MX_GatewayInstanceStruct *chartInstance,
  uint32_T c81_elementIndex);
static void c81_set_ee_EngData(SFc81_MX_GatewayInstanceStruct *chartInstance,
  uint32_T c81_elementIndex, uint8_T c81_elementValue);
static uint8_T *c81_access_ee_EngData(SFc81_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c81_rdOnly);
static uint8_T c81_get_ee_JobClockLHP(SFc81_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c81_elementIndex);
static void c81_set_ee_JobClockLHP(SFc81_MX_GatewayInstanceStruct *chartInstance,
  uint32_T c81_elementIndex, uint8_T c81_elementValue);
static uint8_T *c81_access_ee_JobClockLHP(SFc81_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c81_rdOnly);
static uint8_T c81_get_flag_StdActiveWarn(SFc81_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c81_elementIndex);
static void c81_set_flag_StdActiveWarn(SFc81_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c81_elementIndex, uint8_T c81_elementValue);
static uint8_T *c81_access_flag_StdActiveWarn(SFc81_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c81_rdOnly);
static void init_dsm_address_info(SFc81_MX_GatewayInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc81_MX_GatewayInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc81_MX_Gateway(chartInstance);
  ...
  chartInstance->c81_is_active_c81_MX_Gateway = 0U;
  ...
  (SFc81_MX_GatewayInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c81_is_active_c81_MX_Gateway == 1U) {
  ...
  (SFc81_MX_GatewayInstanceStruct *chartInstance)
{
  ...
  c81_r_hoistedGlobal = chartInstance->c81_is_active_c81_MX_Gateway;
  c81_s_y = NULL;
  ...
  *chartInstance, const mxArray *c81_st)
{
  ...
  *chartInstance->c81_state_RightButton = c81_b_emlrt_marshallIn(chartInstance,
  ...
  chartInstance->c81_is_active_c81_MX_Gateway = c81_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c81_u, 17)),
     "is_active_c81_MX_Gateway");
  ...
  c81_update_debugger_state_c81_MX_Gateway(chartInstance);
...
{
  int32_T c81_i0;
  c81_set_sim_state_side_effects_c81_MX_Gateway(chartInstance);
  ...
  c81_chartstep_c81_MX_Gateway(chartInstance);
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c81_is_active_c81_MX_Gateway == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 78U, chartInstance->c81_sfEvent);
    chartInstance->c81_is_active_c81_MX_Gateway = 1U;
...
const mxArray *sf_c81_MX_Gateway_get_eml_resolved_functions_info(void)
{
  ...
  *c81_inData)
{
  ...
  const mxArray *c81_y = NULL;
  SFc81_MX_GatewayInstanceStruct *chartInstance;
  chartInstance = (SFc81_MX_GatewayInstanceStruct *)chartInstanceVoid;
...
void sf_c81_MX_Gateway_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c81_MX_Gateway_get_post_codegen_info(void);
mxArray *sf_c81_MX_Gateway_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c81_MX_Gateway_get_post_codegen_info();
...
mxArray *sf_c81_MX_Gateway_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c81_MX_Gateway_jit_fallback_info(void)
{
...
mxArray *sf_c81_MX_Gateway_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c81_MX_Gateway(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[3],M[341],T\"debounceRight\",},{M[3],M[891],T\"prev_InfoSecondary\",},{M[3],M[949],T\"prev_SecondAux\",},{M[3],M[118],T\"serviceClockAlarmTimer\",},{M[3],M[122],T\"shutdownTimer\",},{M[3],M[131],T\"state_Jump\",},{M[3],M[132],T\"state_LightButton\",},{M[8],M[0],T\"is_active_c81_MX_Gateway\",},{M[8],M[3],T\"is_active_SECONDARY_STATE\",},{M[8],M[11],T\"is_active_BUTTON_STATE\",}}",
  ...
  sf_c81_MX_Gateway_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc81_MX_GatewayInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc81_MX_GatewayInstanceStruct *chartInstance =
      (SFc81_MX_GatewayInstanceStruct *)sf_get_chart_instance_ptr(S);
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          static int sRelationalopType[] = { 0, 0, 1, 1, 1, 1 };
...

        {
          ...
          static int sRelationalopType[] = { 5, 0 };
...
static void sf_opaque_initialize_c81_MX_Gateway(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc81_MX_GatewayInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c81_MX_Gateway((SFc81_MX_GatewayInstanceStruct*)
    chartInstanceVar);
  initialize_c81_MX_Gateway((SFc81_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c81_MX_Gateway(void *chartInstanceVar)
{
  enable_c81_MX_Gateway((SFc81_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c81_MX_Gateway(void *chartInstanceVar)
{
  disable_c81_MX_Gateway((SFc81_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c81_MX_Gateway(void *chartInstanceVar)
{
  sf_gateway_c81_MX_Gateway((SFc81_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c81_MX_Gateway(SimStruct* S)
{
  return get_sim_state_c81_MX_Gateway((SFc81_MX_GatewayInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c81_MX_Gateway(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c81_MX_Gateway((SFc81_MX_GatewayInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c81_MX_Gateway(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc81_MX_GatewayInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_MX_Gateway_optimization_info();
    }

    finalize_c81_MX_Gateway((SFc81_MX_GatewayInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc81_MX_Gateway((SFc81_MX_GatewayInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c81_MX_Gateway(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c81_MX_Gateway(SimStruct *S)
{
...
static void mdlRTW_c81_MX_Gateway(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c81_MX_Gateway(SimStruct *S)
{
  SFc81_MX_GatewayInstanceStruct *chartInstance;
  chartInstance = (SFc81_MX_GatewayInstanceStruct *)utMalloc(sizeof
    (SFc81_MX_GatewayInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc81_MX_GatewayInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c81_MX_Gateway;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c81_MX_Gateway;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c81_MX_Gateway;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c81_MX_Gateway;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c81_MX_Gateway;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c81_MX_Gateway;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c81_MX_Gateway;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c81_MX_Gateway;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c81_MX_Gateway;
  chartInstance->chartInfo.mdlStart = mdlStart_c81_MX_Gateway;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c81_MX_Gateway;
  ...
  mdl_start_c81_MX_Gateway(chartInstance);
}

void c81_MX_Gateway_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c81_MX_Gateway(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c81_MX_Gateway(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c81_MX_Gateway(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c81_MX_Gateway_method_dispatcher.\n"
