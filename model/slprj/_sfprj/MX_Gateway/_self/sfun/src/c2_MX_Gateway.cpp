...
static void initialize_c2_MX_Gateway(SFc2_MX_GatewayInstanceStruct
  *chartInstance);
static void initialize_params_c2_MX_Gateway(SFc2_MX_GatewayInstanceStruct
  *chartInstance);
static void enable_c2_MX_Gateway(SFc2_MX_GatewayInstanceStruct *chartInstance);
static void disable_c2_MX_Gateway(SFc2_MX_GatewayInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_MX_Gateway(SFc2_MX_GatewayInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_MX_Gateway(SFc2_MX_GatewayInstanceStruct *
  chartInstance);
static void set_sim_state_c2_MX_Gateway(SFc2_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void c2_set_sim_state_side_effects_c2_MX_Gateway
  (SFc2_MX_GatewayInstanceStruct *chartInstance);
static void finalize_c2_MX_Gateway(SFc2_MX_GatewayInstanceStruct *chartInstance);
static void sf_gateway_c2_MX_Gateway(SFc2_MX_GatewayInstanceStruct
  *chartInstance);
static void mdl_start_c2_MX_Gateway(SFc2_MX_GatewayInstanceStruct *chartInstance);
static void c2_chartstep_c2_MX_Gateway(SFc2_MX_GatewayInstanceStruct
  *chartInstance);
static void initSimStructsc2_MX_Gateway(SFc2_MX_GatewayInstanceStruct
  *chartInstance);
static void c2_Deluxe_G55(SFc2_MX_GatewayInstanceStruct *chartInstance);
static void c2_exit_internal_Normal(SFc2_MX_GatewayInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static int32_T c2_emlrt_marshallIn(SFc2_MX_GatewayInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static uint8_T c2_b_emlrt_marshallIn(SFc2_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c2_c_tp_Normal, const char_T *c2_identifier);
static uint8_T c2_c_emlrt_marshallIn(SFc2_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int8_T c2_d_emlrt_marshallIn(SFc2_MX_GatewayInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static const mxArray *c2_e_emlrt_marshallIn(SFc2_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c2_b_setSimStateSideEffectsInfo, const char_T
  *c2_identifier);
static const mxArray *c2_f_emlrt_marshallIn(SFc2_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc2_MX_GatewayInstanceStruct
  *chartInstance, int32_T c2_ssid);
static void c2_init_sf_message_store_memory(SFc2_MX_GatewayInstanceStruct
  *chartInstance);
static int8_T c2__s8_u8_(SFc2_MX_GatewayInstanceStruct *chartInstance, uint8_T
  c2_b, uint32_T c2_ssid_src_loc, int32_T c2_offset_src_loc, int32_T
  c2_length_src_loc);
static int8_T c2_get_ee_AutoIdleEnabled(SFc2_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c2_elementIndex);
static void c2_set_ee_AutoIdleEnabled(SFc2_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c2_elementIndex, int8_T c2_elementValue);
static int8_T *c2_access_ee_AutoIdleEnabled(SFc2_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c2_rdOnly);
static void init_dsm_address_info(SFc2_MX_GatewayInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc2_MX_GatewayInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc2_MX_Gateway(chartInstance);
  ...
  chartInstance->c2_is_active_c2_MX_Gateway = 0U;
  chartInstance->c2_is_c2_MX_Gateway = c2_IN_NO_ACTIVE_CHILD;
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c2_is_active_c2_MX_Gateway == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 1U, chartInstance->c2_sfEvent);
  }

  if (chartInstance->c2_is_c2_MX_Gateway == c2_IN_Normal) {
  ...
  if (chartInstance->c2_is_c2_MX_Gateway == c2_IN_Deluxe_G55) {
  ...
  chartInstance)
{
  ...
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_MX_Gateway;
  c2_c_y = NULL;
  sf_mex_assign(&c2_c_y, sf_mex_create("y", &c2_b_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c2_y, 1, c2_c_y);
  c2_c_hoistedGlobal = chartInstance->c2_is_c2_MX_Gateway;
  c2_d_y = NULL;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *chartInstance->c2_state_AutoIdleEnable = c2_b_emlrt_marshallIn(chartInstance,
  ...
  chartInstance->c2_is_active_c2_MX_Gateway = c2_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_MX_Gateway");
  chartInstance->c2_is_c2_MX_Gateway = c2_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 2)), "is_c2_MX_Gateway");
  ...
  c2_update_debugger_state_c2_MX_Gateway(chartInstance);
  ...
  (SFc2_MX_GatewayInstanceStruct *chartInstance)
{
  if (chartInstance->c2_doSetSimStateSideEffects != 0) {
    chartInstance->c2_tp_Deluxe_G55 = (uint8_T)
      (chartInstance->c2_is_c2_MX_Gateway == c2_IN_Deluxe_G55);
    ...
    chartInstance->c2_b_tp_On = (uint8_T)(chartInstance->c2_b_is_Normal ==
      c2_b_IN_On);
    chartInstance->c2_tp_Normal = (uint8_T)(chartInstance->c2_is_c2_MX_Gateway ==
      c2_IN_Normal);
...
static void sf_gateway_c2_MX_Gateway(SFc2_MX_GatewayInstanceStruct
  *chartInstance)
{
  c2_set_sim_state_side_effects_c2_MX_Gateway(chartInstance);
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_MX_Gateway(chartInstance);
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c2_is_active_c2_MX_Gateway == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 1U, chartInstance->c2_sfEvent);
    chartInstance->c2_is_active_c2_MX_Gateway = 1U;
    ...
    if (c2_out) {
      ...
      chartInstance->c2_is_c2_MX_Gateway = c2_IN_Normal;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 6U, chartInstance->c2_sfEvent);
    ...
    switch (chartInstance->c2_is_c2_MX_Gateway) {
...
const mxArray *sf_c2_MX_Gateway_get_eml_resolved_functions_info(void)
{
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_MX_GatewayInstanceStruct *chartInstance;
  chartInstance = (SFc2_MX_GatewayInstanceStruct *)chartInstanceVoid;
...
void sf_c2_MX_Gateway_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c2_MX_Gateway_get_post_codegen_info(void);
mxArray *sf_c2_MX_Gateway_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_MX_Gateway_get_post_codegen_info();
...
mxArray *sf_c2_MX_Gateway_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_MX_Gateway_jit_fallback_info(void)
{
...
mxArray *sf_c2_MX_Gateway_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_MX_Gateway(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[1],T\"state_AutoIdleEnable\",},{M[8],M[0],T\"is_active_c2_MX_Gateway\",},{M[9],M[0],T\"is_c2_MX_Gateway\",},{M[9],M[73],T\"is_Normal\",},{M[9],M[77],T\"is_Deluxe_G55\",},{M[9],M[90],T\"is_Normal\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_MX_Gateway_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc2_MX_GatewayInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_MX_GatewayInstanceStruct *chartInstance =
      (SFc2_MX_GatewayInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c2_MX_Gateway(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_MX_GatewayInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c2_MX_Gateway((SFc2_MX_GatewayInstanceStruct*)
    chartInstanceVar);
  initialize_c2_MX_Gateway((SFc2_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_MX_Gateway(void *chartInstanceVar)
{
  enable_c2_MX_Gateway((SFc2_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_MX_Gateway(void *chartInstanceVar)
{
  disable_c2_MX_Gateway((SFc2_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_MX_Gateway(void *chartInstanceVar)
{
  sf_gateway_c2_MX_Gateway((SFc2_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_MX_Gateway(SimStruct* S)
{
  return get_sim_state_c2_MX_Gateway((SFc2_MX_GatewayInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_MX_Gateway(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c2_MX_Gateway((SFc2_MX_GatewayInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c2_MX_Gateway(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_MX_GatewayInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_MX_Gateway_optimization_info();
    }

    finalize_c2_MX_Gateway((SFc2_MX_GatewayInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_MX_Gateway((SFc2_MX_GatewayInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_MX_Gateway(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_MX_Gateway(SimStruct *S)
{
...
static void mdlRTW_c2_MX_Gateway(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_MX_Gateway(SimStruct *S)
{
  SFc2_MX_GatewayInstanceStruct *chartInstance;
  chartInstance = (SFc2_MX_GatewayInstanceStruct *)utMalloc(sizeof
    (SFc2_MX_GatewayInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc2_MX_GatewayInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_MX_Gateway;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_MX_Gateway;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_MX_Gateway;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_MX_Gateway;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_MX_Gateway;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_MX_Gateway;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_MX_Gateway;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_MX_Gateway;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_MX_Gateway;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_MX_Gateway;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_MX_Gateway;
  ...
  mdl_start_c2_MX_Gateway(chartInstance);
}

void c2_MX_Gateway_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_MX_Gateway(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_MX_Gateway(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_MX_Gateway(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_MX_Gateway_method_dispatcher.\n"
