...
static void initialize_c1_MX_Gateway(SFc1_MX_GatewayInstanceStruct
  *chartInstance);
static void initialize_params_c1_MX_Gateway(SFc1_MX_GatewayInstanceStruct
  *chartInstance);
static void enable_c1_MX_Gateway(SFc1_MX_GatewayInstanceStruct *chartInstance);
static void disable_c1_MX_Gateway(SFc1_MX_GatewayInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_MX_Gateway(SFc1_MX_GatewayInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_MX_Gateway(SFc1_MX_GatewayInstanceStruct *
  chartInstance);
static void set_sim_state_c1_MX_Gateway(SFc1_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c1_st);
static void c1_set_sim_state_side_effects_c1_MX_Gateway
  (SFc1_MX_GatewayInstanceStruct *chartInstance);
static void finalize_c1_MX_Gateway(SFc1_MX_GatewayInstanceStruct *chartInstance);
static void sf_gateway_c1_MX_Gateway(SFc1_MX_GatewayInstanceStruct
  *chartInstance);
static void mdl_start_c1_MX_Gateway(SFc1_MX_GatewayInstanceStruct *chartInstance);
static void initSimStructsc1_MX_Gateway(SFc1_MX_GatewayInstanceStruct
  *chartInstance);
static void c1_enter_internal_NORMAL(SFc1_MX_GatewayInstanceStruct
  *chartInstance);
static void c1_b_NORMAL(SFc1_MX_GatewayInstanceStruct *chartInstance);
static void c1_exit_internal_NORMAL(SFc1_MX_GatewayInstanceStruct *chartInstance);
static void c1_CRANKING(SFc1_MX_GatewayInstanceStruct *chartInstance);
static void c1_exit_internal_CRANKING(SFc1_MX_GatewayInstanceStruct
  *chartInstance);
static void c1_exit_internal_NOT_RUNNING(SFc1_MX_GatewayInstanceStruct
  *chartInstance);
static void c1_RUNNING(SFc1_MX_GatewayInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static int32_T c1_emlrt_marshallIn(SFc1_MX_GatewayInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint8_T c1_b_emlrt_marshallIn(SFc1_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c1_b_tp_NORMAL, const char_T *c1_identifier);
static uint8_T c1_c_emlrt_marshallIn(SFc1_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint16_T c1_d_emlrt_marshallIn(SFc1_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c1_b_CD_ENGINE_SPEED_RUNNING, const char_T
  *c1_identifier);
static uint16_T c1_e_emlrt_marshallIn(SFc1_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint32_T c1_f_emlrt_marshallIn(SFc1_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static boolean_T c1_g_emlrt_marshallIn(SFc1_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c1_b_flag_PrimeComplete, const char_T
  *c1_identifier);
static boolean_T c1_h_emlrt_marshallIn(SFc1_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_i_emlrt_marshallIn(SFc1_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c1_b_setSimStateSideEffectsInfo, const char_T
  *c1_identifier);
static const mxArray *c1_j_emlrt_marshallIn(SFc1_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc1_MX_GatewayInstanceStruct
  *chartInstance, int32_T c1_ssid);
static void c1_init_sf_message_store_memory(SFc1_MX_GatewayInstanceStruct
  *chartInstance);
static uint16_T c1__u16_s32_(SFc1_MX_GatewayInstanceStruct *chartInstance,
  int32_T c1_b, uint32_T c1_ssid_src_loc, int32_T c1_offset_src_loc, int32_T
  c1_length_src_loc);
static int32_T c1__s32_add__(SFc1_MX_GatewayInstanceStruct *chartInstance,
  int32_T c1_b, int32_T c1_c, uint32_T c1_ssid_src_loc, int32_T
  c1_offset_src_loc, int32_T c1_length_src_loc);
static void init_dsm_address_info(SFc1_MX_GatewayInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc1_MX_GatewayInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc1_MX_Gateway(chartInstance);
  ...
  chartInstance->c1_is_active_c1_MX_Gateway = 0U;
  chartInstance->c1_is_c1_MX_Gateway = c1_IN_NO_ACTIVE_CHILD;
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_c1_MX_Gateway == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
  }

  if (chartInstance->c1_is_c1_MX_Gateway == c1_IN_NORMAL) {
  ...
  chartInstance)
{
  ...
  c1_g_hoistedGlobal = chartInstance->c1_is_active_c1_MX_Gateway;
  c1_h_y = NULL;
  sf_mex_assign(&c1_h_y, sf_mex_create("y", &c1_g_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c1_y, 6, c1_h_y);
  c1_h_hoistedGlobal = chartInstance->c1_is_c1_MX_Gateway;
  c1_i_y = NULL;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  *chartInstance->c1_state_TurboPrime = c1_b_emlrt_marshallIn(chartInstance,
  ...
  chartInstance->c1_is_active_c1_MX_Gateway = c1_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 6)),
     "is_active_c1_MX_Gateway");
  chartInstance->c1_is_c1_MX_Gateway = c1_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 7)), "is_c1_MX_Gateway");
  ...
  c1_update_debugger_state_c1_MX_Gateway(chartInstance);
  ...
  (SFc1_MX_GatewayInstanceStruct *chartInstance)
{
  if (chartInstance->c1_doSetSimStateSideEffects != 0) {
    chartInstance->c1_tp_NORMAL = (uint8_T)(chartInstance->c1_is_c1_MX_Gateway ==
      c1_IN_NORMAL);
    ...
    chartInstance->c1_tp_RUNNING = (uint8_T)(chartInstance->c1_is_NORMAL ==
      c1_IN_RUNNING);
    chartInstance->c1_tp_SHUTDOWN = (uint8_T)(chartInstance->c1_is_c1_MX_Gateway
      == c1_IN_SHUTDOWN);
    chartInstance->c1_tp_ST_SHUTDOWN = (uint8_T)
      (chartInstance->c1_is_c1_MX_Gateway == c1_IN_ST_SHUTDOWN);
    chartInstance->c1_doSetSimStateSideEffects = 0U;
  }
}
  ...
  *chartInstance)
{
  boolean_T c1_temp;
  boolean_T c1_out;
  c1_set_sim_state_side_effects_c1_MX_Gateway(chartInstance);
  ...
  if (chartInstance->c1_is_active_c1_MX_Gateway == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_active_c1_MX_Gateway = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 9U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_c1_MX_Gateway = c1_IN_NORMAL;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
    ...
    *chartInstance->c1_state_TurboPrime = chartInstance->c1_NORMAL;
    ...
    switch (chartInstance->c1_is_c1_MX_Gateway) {
     case c1_IN_NORMAL:
  ...
  if (c1_out) {
    ...
    *chartInstance->c1_state_Engine = chartInstance->c1_ENGINE_OFF;
    ...
    if (c1_b_out) {
      ...
      chartInstance->c1_tp_NORMAL = 0U;
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
      chartInstance->c1_is_c1_MX_Gateway = c1_IN_SHUTDOWN;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 12U, chartInstance->c1_sfEvent);
...
const mxArray *sf_c1_MX_Gateway_get_eml_resolved_functions_info(void)
{
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_MX_GatewayInstanceStruct *chartInstance;
  chartInstance = (SFc1_MX_GatewayInstanceStruct *)chartInstanceVoid;
...
void sf_c1_MX_Gateway_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c1_MX_Gateway_get_post_codegen_info(void);
mxArray *sf_c1_MX_Gateway_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c1_MX_Gateway_get_post_codegen_info();
...
mxArray *sf_c1_MX_Gateway_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_MX_Gateway_jit_fallback_info(void)
{
...
mxArray *sf_c1_MX_Gateway_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_MX_Gateway(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[22],T\"state_Engine\",},{M[1],M[224],T\"state_TurboPrime\",},{M[3],M[127],T\"debounceCount\",},{M[3],M[220],T\"debouncePrimer\",},{M[3],M[223],T\"flag_PrimeComplete\",},{M[3],M[187],T\"panelMissingDebounce\",},{M[8],M[0],T\"is_active_c1_MX_Gateway\",},{M[9],M[0],T\"is_c1_MX_Gateway\",},{M[9],M[1],T\"is_NOT_RUNNING\",},{M[9],M[80],T\"is_NORMAL\",}}",
  ...
  sf_c1_MX_Gateway_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc1_MX_GatewayInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_MX_GatewayInstanceStruct *chartInstance =
      (SFc1_MX_GatewayInstanceStruct *)sf_get_chart_instance_ptr(S);
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          static int sRelationalopType[] = { 0, 0, 0, 0, 0, 0, 0, 0, 1, 4 };
...

        {
          ...
          static int sRelationalopType[] = { 0, 0, 0, 0, 0, 0, 1, 0, 0 };
...

        {
          ...
          static int sRelationalopType[] = { 1, 1, 1, 1, 1, 0 };
...

        {
          ...
          static int sRelationalopType[] = { 3, 1 };
...

        {
          ...
          static int sRelationalopType[] = { 1, 3, 0 };
...

        {
          ...
          static int sRelationalopType[] = { 5, 0, 0 };
...

        {
          ...
          static int sRelationalopType[] = { 1, 1, 0, 0, 0 };
...
static void sf_opaque_initialize_c1_MX_Gateway(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_MX_GatewayInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c1_MX_Gateway((SFc1_MX_GatewayInstanceStruct*)
    chartInstanceVar);
  initialize_c1_MX_Gateway((SFc1_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_MX_Gateway(void *chartInstanceVar)
{
  enable_c1_MX_Gateway((SFc1_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_MX_Gateway(void *chartInstanceVar)
{
  disable_c1_MX_Gateway((SFc1_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_MX_Gateway(void *chartInstanceVar)
{
  sf_gateway_c1_MX_Gateway((SFc1_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c1_MX_Gateway(SimStruct* S)
{
  return get_sim_state_c1_MX_Gateway((SFc1_MX_GatewayInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c1_MX_Gateway(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c1_MX_Gateway((SFc1_MX_GatewayInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c1_MX_Gateway(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_MX_GatewayInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_MX_Gateway_optimization_info();
    }

    finalize_c1_MX_Gateway((SFc1_MX_GatewayInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_MX_Gateway((SFc1_MX_GatewayInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_MX_Gateway(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_MX_Gateway(SimStruct *S)
{
...
static void mdlRTW_c1_MX_Gateway(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_MX_Gateway(SimStruct *S)
{
  SFc1_MX_GatewayInstanceStruct *chartInstance;
  chartInstance = (SFc1_MX_GatewayInstanceStruct *)utMalloc(sizeof
    (SFc1_MX_GatewayInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc1_MX_GatewayInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_MX_Gateway;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_MX_Gateway;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_MX_Gateway;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_MX_Gateway;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_MX_Gateway;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_MX_Gateway;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_MX_Gateway;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_MX_Gateway;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_MX_Gateway;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_MX_Gateway;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_MX_Gateway;
  ...
  mdl_start_c1_MX_Gateway(chartInstance);
}

void c1_MX_Gateway_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_MX_Gateway(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_MX_Gateway(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_MX_Gateway(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_MX_Gateway_method_dispatcher.\n"
