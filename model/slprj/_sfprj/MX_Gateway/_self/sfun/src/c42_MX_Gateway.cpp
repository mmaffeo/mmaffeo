...
static void initialize_c42_MX_Gateway(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void initialize_params_c42_MX_Gateway(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void enable_c42_MX_Gateway(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void disable_c42_MX_Gateway(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_update_debugger_state_c42_MX_Gateway
  (SFc42_MX_GatewayInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c42_MX_Gateway
  (SFc42_MX_GatewayInstanceStruct *chartInstance);
static void set_sim_state_c42_MX_Gateway(SFc42_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c42_st);
static void c42_set_sim_state_side_effects_c42_MX_Gateway
  (SFc42_MX_GatewayInstanceStruct *chartInstance);
static void finalize_c42_MX_Gateway(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void sf_gateway_c42_MX_Gateway(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void mdl_start_c42_MX_Gateway(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_c42_MX_Gateway(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void initSimStructsc42_MX_Gateway(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_Detent_State(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_Non_Functional(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_Detent(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_exit_internal_Active_Normal(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_b_Detent(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_b_exit_internal_Active_Normal(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_Aux_Enable_State(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_PHOENIX_K2(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_enter_internal_Functional(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_Functional(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_exit_internal_Functional(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_enter_internal_Enabled(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_exit_internal_Enabled(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_Active(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_exit_internal_Active(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_Inactive(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_Inactive_Out_Of_Neutral(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_Aux_Relief_G5(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_exit_internal_Aux_Relief_G5(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_exit_internal_Aux_Enable_State_ST(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_exit_internal_Aux_Enable_State_ACD
  (SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_SIRIUS2(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_b_enter_internal_Functional(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_b_Functional(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_b_exit_internal_Functional(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_b_enter_internal_Enabled(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_b_exit_internal_Enabled(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_b_Active(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_b_exit_internal_Active(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_Inactive_Fault(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_b_Inactive_Out_Of_Neutral(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_b_exit_internal_Aux_Enable_State_ST
  (SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_b_exit_internal_Aux_Enable_State_ACD
  (SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_SIRIUS2_HIFLOW(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_c_enter_internal_Functional(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_c_Functional(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_c_exit_internal_Functional(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_c_enter_internal_Enabled(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_c_exit_internal_Enabled(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_c_Active(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_c_exit_internal_Active(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_b_Inactive_Fault(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_c_Inactive_Out_Of_Neutral(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_c_exit_internal_Aux_Enable_State_ST
  (SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_c_exit_internal_Aux_Enable_State_ACD
  (SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_EMEA_CONTROLS(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_d_enter_internal_Functional(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_d_Functional(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_d_exit_internal_Functional(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_d_enter_internal_Enabled(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_Enabled(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_d_exit_internal_Enabled(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_d_Active(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void c42_d_exit_internal_Active(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static void c42_d_Inactive_Out_Of_Neutral(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
...
static const mxArray *c42_sf_marshallOut(void *chartInstanceVoid, void
  *c42_inData);
static int32_T c42_emlrt_marshallIn(SFc42_MX_GatewayInstanceStruct
...
static const mxArray *c42_b_sf_marshallOut(void *chartInstanceVoid, void
  *c42_inData);
static uint8_T c42_b_emlrt_marshallIn(SFc42_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c42_b_tp_Detent_State, const char_T
  *c42_identifier);
static uint8_T c42_c_emlrt_marshallIn(SFc42_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c42_u, const emlrtMsgIdentifier *c42_parentId);
...
static const mxArray *c42_d_sf_marshallOut(void *chartInstanceVoid, void
  *c42_inData);
static uint16_T c42_d_emlrt_marshallIn(SFc42_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c42_b_CD_AUX_RELEASE_TIME, const char_T
  *c42_identifier);
static uint16_T c42_e_emlrt_marshallIn(SFc42_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c42_u, const emlrtMsgIdentifier *c42_parentId);
static void c42_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c42_mxArrayInData, const char_T *c42_varName, void *c42_outData);
static boolean_T c42_f_emlrt_marshallIn(SFc42_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c42_b_previouslyActive, const char_T
  *c42_identifier);
static boolean_T c42_g_emlrt_marshallIn(SFc42_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c42_u, const emlrtMsgIdentifier *c42_parentId);
static void c42_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c42_mxArrayInData, const char_T *c42_varName, void *c42_outData);
static uint32_T c42_h_emlrt_marshallIn(SFc42_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c42_b_temporalCounter_i1, const char_T
  *c42_identifier);
static uint32_T c42_i_emlrt_marshallIn(SFc42_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c42_u, const emlrtMsgIdentifier *c42_parentId);
static const mxArray *c42_j_emlrt_marshallIn(SFc42_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c42_b_setSimStateSideEffectsInfo, const char_T *
  c42_identifier);
static const mxArray *c42_k_emlrt_marshallIn(SFc42_MX_GatewayInstanceStruct
  *chartInstance, const mxArray *c42_u, const emlrtMsgIdentifier *c42_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc42_MX_GatewayInstanceStruct
  *chartInstance, int32_T c42_ssid);
static void c42_init_sf_message_store_memory(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
static uint16_T c42__u16_s32_(SFc42_MX_GatewayInstanceStruct *chartInstance,
  int32_T c42_b, uint32_T c42_ssid_src_loc, int32_T c42_offset_src_loc, int32_T
  c42_length_src_loc);
static uint32_T c42__u32_s32_(SFc42_MX_GatewayInstanceStruct *chartInstance,
  int32_T c42_b, uint32_T c42_ssid_src_loc, int32_T c42_offset_src_loc, int32_T
  c42_length_src_loc);
static uint16_T c42__u16_u32_(SFc42_MX_GatewayInstanceStruct *chartInstance,
  uint32_T c42_b, uint32_T c42_ssid_src_loc, int32_T c42_offset_src_loc, int32_T
  c42_length_src_loc);
static uint8_T c42_get_ee_AuxFlow(SFc42_MX_GatewayInstanceStruct *chartInstance,
  uint32_T c42_elementIndex);
static void c42_set_ee_AuxFlow(SFc42_MX_GatewayInstanceStruct *chartInstance,
  uint32_T c42_elementIndex, uint8_T c42_elementValue);
static uint8_T *c42_access_ee_AuxFlow(SFc42_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c42_rdOnly);
static uint8_T c42_get_ee_DeluxeG5(SFc42_MX_GatewayInstanceStruct *chartInstance,
  uint32_T c42_elementIndex);
static void c42_set_ee_DeluxeG5(SFc42_MX_GatewayInstanceStruct *chartInstance,
  uint32_T c42_elementIndex, uint8_T c42_elementValue);
static uint8_T *c42_access_ee_DeluxeG5(SFc42_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c42_rdOnly);
static uint8_T c42_get_state_Buzzer(SFc42_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c42_elementIndex);
static void c42_set_state_Buzzer(SFc42_MX_GatewayInstanceStruct *chartInstance,
  uint32_T c42_elementIndex, uint8_T c42_elementValue);
static uint8_T *c42_access_state_Buzzer(SFc42_MX_GatewayInstanceStruct
  *chartInstance, uint32_T c42_rdOnly);
static void init_dsm_address_info(SFc42_MX_GatewayInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc42_MX_GatewayInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc42_MX_Gateway(chartInstance);
  ...
  chartInstance->c42_is_active_c42_MX_Gateway = 0U;
  ...
  (SFc42_MX_GatewayInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c42_is_active_c42_MX_Gateway == 1U) {
  ...
  (SFc42_MX_GatewayInstanceStruct *chartInstance)
{
  ...
  c42_j_hoistedGlobal = chartInstance->c42_is_active_c42_MX_Gateway;
  c42_k_y = NULL;
  ...
  *chartInstance, const mxArray *c42_st)
{
  ...
  *chartInstance->c42_state_DetentEnable = c42_b_emlrt_marshallIn(chartInstance,
  ...
  chartInstance->c42_is_active_c42_MX_Gateway = c42_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c42_u, 9)),
     "is_active_c42_MX_Gateway");
  ...
  c42_update_debugger_state_c42_MX_Gateway(chartInstance);
...
static void sf_gateway_c42_MX_Gateway(SFc42_MX_GatewayInstanceStruct
  *chartInstance)
{
  c42_set_sim_state_side_effects_c42_MX_Gateway(chartInstance);
  ...
  c42_c42_MX_Gateway(chartInstance);
...
static void c42_c42_MX_Gateway(SFc42_MX_GatewayInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c42_is_active_c42_MX_Gateway == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 40U, chartInstance->c42_sfEvent);
    chartInstance->c42_is_active_c42_MX_Gateway = 1U;
...
const mxArray *sf_c42_MX_Gateway_get_eml_resolved_functions_info(void)
{
  ...
  *c42_inData)
{
  ...
  const mxArray *c42_y = NULL;
  SFc42_MX_GatewayInstanceStruct *chartInstance;
  chartInstance = (SFc42_MX_GatewayInstanceStruct *)chartInstanceVoid;
...
void sf_c42_MX_Gateway_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c42_MX_Gateway_get_post_codegen_info(void);
mxArray *sf_c42_MX_Gateway_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c42_MX_Gateway_get_post_codegen_info();
...
mxArray *sf_c42_MX_Gateway_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c42_MX_Gateway_jit_fallback_info(void)
{
...
mxArray *sf_c42_MX_Gateway_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c42_MX_Gateway(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[166],T\"aux_Flow\",},{M[1],M[603],T\"cmd_AuxRelease\",},{M[1],M[68],T\"state_AuxEnable\",},{M[1],M[938],T\"state_AuxRelease\",},{M[1],M[73],T\"state_Detent\",},{M[1],M[280],T\"state_DetentEnable\",},{M[3],M[1285],T\"previouslyActive\",},{M[3],M[570],T\"state_ACD_old\",},{M[3],M[571],T\"state_ST_old\",},{M[8],M[0],T\"is_active_c42_MX_Gateway\",}}",
  ...
  sf_c42_MX_Gateway_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc42_MX_GatewayInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc42_MX_GatewayInstanceStruct *chartInstance =
      (SFc42_MX_GatewayInstanceStruct *)sf_get_chart_instance_ptr(S);
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          static int sRelationalopType[] = { 1, 0, 1 };
...

        {
          ...
          static int sRelationalopType[] = { 0, 0, 0, 1 };
...

        {
          ...
          static int sRelationalopType[] = { 0, 0, 1 };
...

        {
          ...
          static int sRelationalopType[] = { 0, 1 };
...

        {
          ...
          static int sRelationalopType[] = { 1, 1, 0 };
...

        {
          ...
          static int sRelationalopType[] = { 1, 0, 0, 0, 0, 0 };
...

        {
          ...
          static int sRelationalopType[] = { 0, 1, 1 };
...

        {
          ...
          static int sRelationalopType[] = { 1, 1, 0, 1 };
...

        {
          ...
          static int sRelationalopType[] = { 0, 0, 0, 0, 0, 1 };
...

        {
          ...
          static int sRelationalopType[] = { 1, 0, 0 };
...
static void sf_opaque_initialize_c42_MX_Gateway(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc42_MX_GatewayInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c42_MX_Gateway((SFc42_MX_GatewayInstanceStruct*)
    chartInstanceVar);
  initialize_c42_MX_Gateway((SFc42_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c42_MX_Gateway(void *chartInstanceVar)
{
  enable_c42_MX_Gateway((SFc42_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c42_MX_Gateway(void *chartInstanceVar)
{
  disable_c42_MX_Gateway((SFc42_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c42_MX_Gateway(void *chartInstanceVar)
{
  sf_gateway_c42_MX_Gateway((SFc42_MX_GatewayInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c42_MX_Gateway(SimStruct* S)
{
  return get_sim_state_c42_MX_Gateway((SFc42_MX_GatewayInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c42_MX_Gateway(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c42_MX_Gateway((SFc42_MX_GatewayInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c42_MX_Gateway(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc42_MX_GatewayInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_MX_Gateway_optimization_info();
    }

    finalize_c42_MX_Gateway((SFc42_MX_GatewayInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc42_MX_Gateway((SFc42_MX_GatewayInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c42_MX_Gateway(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c42_MX_Gateway(SimStruct *S)
{
...
static void mdlRTW_c42_MX_Gateway(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c42_MX_Gateway(SimStruct *S)
{
  SFc42_MX_GatewayInstanceStruct *chartInstance;
  chartInstance = (SFc42_MX_GatewayInstanceStruct *)utMalloc(sizeof
    (SFc42_MX_GatewayInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc42_MX_GatewayInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c42_MX_Gateway;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c42_MX_Gateway;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c42_MX_Gateway;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c42_MX_Gateway;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c42_MX_Gateway;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c42_MX_Gateway;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c42_MX_Gateway;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c42_MX_Gateway;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c42_MX_Gateway;
  chartInstance->chartInfo.mdlStart = mdlStart_c42_MX_Gateway;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c42_MX_Gateway;
  ...
  mdl_start_c42_MX_Gateway(chartInstance);
}

void c42_MX_Gateway_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c42_MX_Gateway(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c42_MX_Gateway(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c42_MX_Gateway(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c42_MX_Gateway_method_dispatcher.\n"
