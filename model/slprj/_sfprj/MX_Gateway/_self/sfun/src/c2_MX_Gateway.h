#ifndef __c2_MX_Gateway_h__
#define __c2_MX_Gateway_h__

/* Type Definitions */
#ifndef typedef_SFc2_MX_GatewayInstanceStruct
#define typedef_SFc2_MX_GatewayInstanceStruct
...
typedef struct {
  ...
  uint8_T c2_b_tp_On;
  uint8_T c2_tp_Error;
  uint8_T c2_is_active_c2_MX_Gateway;
  uint8_T c2_is_c2_MX_Gateway;
...
#endif                                 /*typedef_SFc2_MX_GatewayInstanceStruct*/
...
extern const mxArray *sf_c2_MX_Gateway_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c2_MX_Gateway_get_check_sum(mxArray *plhs[]);
extern void c2_MX_Gateway_method_dispatcher(SimStruct *S, int_T method, void
  *data);
