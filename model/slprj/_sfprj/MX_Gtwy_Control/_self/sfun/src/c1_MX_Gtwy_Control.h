#ifndef __c1_MX_Gtwy_Control_h__
#define __c1_MX_Gtwy_Control_h__

/* Type Definitions */
#ifndef typedef_SFc1_MX_Gtwy_ControlInstanceStruct
#define typedef_SFc1_MX_Gtwy_ControlInstanceStruct
...
typedef struct {
  ...
  uint8_T c1_is_active_c1_MX_Gtwy_Control;
  uint8_T c1_is_c1_MX_Gtwy_Control;
...
#endif                                 /*typedef_SFc1_MX_Gtwy_ControlInstanceStruct*/
...
extern const mxArray *sf_c1_MX_Gtwy_Control_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c1_MX_Gtwy_Control_get_check_sum(mxArray *plhs[]);
extern void c1_MX_Gtwy_Control_method_dispatcher(SimStruct *S, int_T method,
  void *data);
