...
extern uint32_t const * CDATA_MAP;

#define SIZE_OF_MXGTW_VBATTERYGAUGE 81
extern uint8_t const * MXGTW_VBATTERYGAUGE;

#define SIZE_OF_MXGTW_FUEL_PULL_TIME 43
extern uint16_t const * MXGTW_FUEL_PULL_TIME;

#define SIZE_OF_MXGTW_ECTSNDINPUT 341
extern uint16_t const * MXGTW_ECTSNDINPUT;

#define SIZE_OF_MXGTW_ECTSNDOUTPUT 341
extern uint16_t const * MXGTW_ECTSNDOUTPUT;

#define SIZE_OF_MXGTW_ECTGAUGE 341
extern uint16_t const * MXGTW_ECTGAUGE;

#define SIZE_OF_MXGTW_HOTSND 341
extern uint16_t const * MXGTW_HOTSND;

#define SIZE_OF_MXGTW_HOTGAUGE 341
extern uint16_t const * MXGTW_HOTGAUGE;

#define SIZE_OF_MXGTW_EOPSND 151
extern uint16_t const * MXGTW_EOPSND;

#define SIZE_OF_MXGTW_EOPGAUGE 151
extern uint16_t const * MXGTW_EOPGAUGE;

#define SIZE_OF_MXGTW_EOPWARN 51
extern uint16_t const * MXGTW_EOPWARN;

#define SIZE_OF_MXGTW_EOPSHUTDOWN 51
extern uint16_t const * MXGTW_EOPSHUTDOWN;

#define SIZE_OF_MXGTW_OFFSET 161
extern uint16_t const * MXGTW_OFFSET; //fixdt(0,16,12) 

#define SIZE_OF_MXGTW_ECU_GLOW_TEMP 16
extern uint16_t const * MXGTW_ECU_GLOW_TEMP;

#define SIZE_OF_MXGTW_FUELGAUGE 256
extern uint16_t const * MXGTW_FUELGAUGE;

#define SIZE_OF_MXGTW_FUELSND 256
extern uint16_t const * MXGTW_FUELSND;

#define SIZE_OF_MXGTW_AUXHYD1 161
extern uint16_t const * MXGTW_AUXHYD1; //fixdt(0,16,12) 

#define SIZE_OF_MXGTW_AUXHYD2 161
extern uint16_t const * MXGTW_AUXHYD2; //fixdt(0,16,12) 

#define SIZE_OF_MXGTW_AUXHYD3 161
extern uint16_t const * MXGTW_AUXHYD3; //fixdt(0,16,12) 

#define SIZE_OF_MXGTW_SERVICE_DEFAULT_HOURS 6
extern uint16_t const * MXGTW_SERVICE_DEFAULT_HOURS;

#define SIZE_OF_MXGTW_SERVICE_DEFAULT_ICON 6
extern uint8_t const * MXGTW_SERVICE_DEFAULT_ICON;

#define SIZE_OF_MXGTW_SERVICE_DEFAULT_TEXT 6
extern uint8_t const * MXGTW_SERVICE_DEFAULT_TEXT;

#define SIZE_OF_MXGTW_VITAL_DEFAULT_ICON 6
extern uint8_t const * MXGTW_VITAL_DEFAULT_ICON;

#define SIZE_OF_MXGTW_VITAL_DEFAULT_UNITS 6
extern uint8_t const * MXGTW_VITAL_DEFAULT_UNITS;

#define SIZE_OF_MXGTW_VITAL_DEFAULT_WARNING 6
extern uint16_t const * MXGTW_VITAL_DEFAULT_WARNING;

#define SIZE_OF_MXGTW_VITAL_DEFAULT_SHUTDOWN 6
extern uint16_t const * MXGTW_VITAL_DEFAULT_SHUTDOWN;

#define SIZE_OF_MXGTW_GATEWAY_J1939_ID 30
extern uint32_t const * MXGTW_GATEWAY_J1939_ID;

#define SIZE_OF_MXGTW_GATEWAY_J1939_MASK 30
extern uint32_t const * MXGTW_GATEWAY_J1939_MASK;

#define SIZE_OF_MXGTW_GATEWAY_DIRECTION 30
extern uint8_t const * MXGTW_GATEWAY_DIRECTION;

#define SIZE_OF_MXGTW_HYD_RESPONSE_IN 26
extern uint16_t const * MXGTW_HYD_RESPONSE_IN;

#define SIZE_OF_MXGTW_HYD_RESPONSE_OUT1 26
extern uint16_t const * MXGTW_HYD_RESPONSE_OUT1; //fixdt(0,16,12) 

#define SIZE_OF_MXGTW_HYD_RESPONSE_OUT2 26
extern uint16_t const * MXGTW_HYD_RESPONSE_OUT2; //fixdt(0,16,12) 

#define SIZE_OF_MXGTW_HYD_RESPONSE_OUT3 26
extern uint16_t const * MXGTW_HYD_RESPONSE_OUT3; //fixdt(0,16,12) 

#define SIZE_OF_MXGTW_HYD_RESPONSE_OUT4 26
extern uint16_t const * MXGTW_HYD_RESPONSE_OUT4; //fixdt(0,16,12) 

#define SIZE_OF_MXGTW_OFFSET_AUX 161
extern uint16_t const * MXGTW_OFFSET_AUX; //fixdt(0,16,12) 

#define SIZE_OF_MXGTW_ECU_GLOW_TIME 16
extern uint16_t const * MXGTW_ECU_GLOW_TIME;

#define SIZE_OF_MXGTW_ECU_DERATE_RPM 20
extern uint16_t const * MXGTW_ECU_DERATE_RPM;

#define SIZE_OF_MXGTW_STARTER_AUTOMATED_OIL_TEMP 10
extern uint16_t const * MXGTW_STARTER_AUTOMATED_OIL_TEMP;

#define SIZE_OF_MXGTW_STARTER_AUTOMATED_RPM_ENGAGE_LEVEL 10
extern uint16_t const * MXGTW_STARTER_AUTOMATED_RPM_ENGAGE_LEVEL;

#define SIZE_OF_MXGTW_STARTER_AUTOMATED_RPM_DISENGAGE_LEVEL 10
extern uint16_t const * MXGTW_STARTER_AUTOMATED_RPM_DISENGAGE_LEVEL;

#define SIZE_OF_MXGTW_STARTER_AUTOMATED_MAX_TIME 10
extern uint16_t const * MXGTW_STARTER_AUTOMATED_MAX_TIME;

#define SIZE_OF_MXGTW_ECU_DERATE_TORQUE 20
extern uint16_t const * MXGTW_ECU_DERATE_TORQUE;

#define SIZE_OF_MXGTW_AUX2_FLOW 101
extern uint16_t const * MXGTW_AUX2_FLOW; //fixdt(0,16,16) 

#define SIZE_OF_GTW_PCODE_ECU_ASCIIPCODE 230
extern uint32_t const * GTW_PCODE_ECU_ASCIIPCODE;

#define SIZE_OF_GTW_PCODE_ECU_SPNLOOKUP 230
extern uint32_t const * GTW_PCODE_ECU_SPNLOOKUP;
